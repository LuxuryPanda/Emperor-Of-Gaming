...
},{"./raf.js":35}],6:[function(require,module,exports){
"use strict";
...
},{"./hasClass.js":27}],7:[function(require,module,exports){
"use strict";
...
},{"./passiveOption.js":33}],8:[function(require,module,exports){
"use strict";
...
},{"./getBody.js":20,"./resetFakeBody.js":40,"./setFakeBody.js":42}],11:[function(require,module,exports){
"use strict";
...
-----------------*/require('./global/accordions');/*------------
    UTILS 
------------*/require('./utils/svg-loader');require('./utils/liquidify');require('./utils/demo-icons');/*------------
    FORM 
------------*/require('./form/form-rating');require('./form/form-counter');require('./form/form-switch');require('./form/form-input');require('./form/interactive-input');/*--------------------------
    ANIMAZIONI FORM HOME
--------------------------*/require('./home/animazioni_home');/*-------------
    HEADER 
-------------*/require('./header/header.progressBar');require('./header/header.dropdown');/*-------------
    SIDEBAR 
...
----------*/require('./global/maps');/*---------------
    CONTENT 
---------------*/require('./content/content.progressBar');require('./content/content.slider');require('./content/content.dropdown');require('./content/content.tab');/*-------------
    CHARTS
-------------*/require('./global/charts');

},{"./content/content.dropdown":49,"./content/content.progressBar":50,"./content/content.slider":51,"./content/content.tab":52,"./form/form-counter":53,"./form/form-input":54,"./form/form-rating":55,"./form/form-switch":56,"./form/interactive-input":57,"./global/accordions":58,"./global/charts":59,"./global/maps":60,"./global/page-loader":61,"./global/popups":62,"./global/tooltips":63,"./global/user-avatar.hexagons":64,"./header/header.dropdown":65,"./header/header.progressBar":66,"./home/animazioni_home":67,"./sidebar/sidebar":68,"./utils/demo-icons":70,"./utils/liquidify":71,"./utils/svg-loader":73,"simplebar":3}],49:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins');plugins.createDropdown({trigger:'.widget-box-post-settings-dropdown-trigger',container:'.widget-box-post-settings-dropdown',offset:{top:30,right:9},animation:{type:'translate-top',speed:.3,translateOffset:{vertical:20}}});plugins.createDropdown({trigger:'.reaction-item-dropdown-trigger',container:'.reaction-item-dropdown',triggerEvent:'hover',offset:{bottom:38,left:-16},animation:{type:'translate-bottom',speed:.3,translateOffset:{vertical:20}}});plugins.createDropdown({trigger:'.reaction-options-dropdown-trigger',container:'.reaction-options-dropdown',triggerEvent:'click',offset:{bottom:54,left:-16},animation:{type:'translate-bottom',speed:.3,translateOffset:{vertical:20}},closeOnDropdownClick:true});plugins.createDropdown({trigger:'.reaction-options-small-dropdown-trigger',container:'.reaction-options-small-dropdown',triggerEvent:'click',offset:{bottom:30,left:-80},animation:{type:'translate-bottom',speed:.3,translateOffset:{vertical:16}},closeOnDropdownClick:true});plugins.createDropdown({trigger:'.post-settings-dropdown-trigger',container:'.post-settings-dropdown',offset:{bottom:30,right:0},animation:{type:'translate-bottom',speed:.3,translateOffset:{vertical:16}}});

},{"../utils/plugins":72}],50:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins');/*-----------------------
    EXP TO NEXT LEVEL
-----------------------*/plugins.createProgressBar({container:'#exp-to-next-level',height:6,lineColor:'#293249'});plugins.createProgressBar({container:'#exp-to-next-level',height:6,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:200,stop:162},linkText:true,linkUnits:'exp',invertedProgress:true,animateOnScroll:true});/*----------------
    BADGE ITEM
----------------*/plugins.createProgressBar({container:'#badge-bronze',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-bronze',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-silver',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-silver',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:100},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-gold',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-gold',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:500,stop:461},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-platinum',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-platinum',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1000,stop:461},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-traveller',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-traveller',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:5,stop:4},invertedProgress:true,linkText:true,linkUnits:'topics',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-caffeinated',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-caffeinated',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:0},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-upowered',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-upowered',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:50,stop:42},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-scientist',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-scientist',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-ncreature',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-ncreature',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:100},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-warrior',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-warrior',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-liked',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-liked',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:500,stop:462},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-sloved',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-sloved',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1000,stop:462},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-qconq',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-qconq',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:10,stop:4},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-villain',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-villain',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:89},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-age',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-age',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:730,stop:605},invertedProgress:true,linkText:true,linkUnits:'days',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-tstruck',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-tstruck',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:50,stop:41},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-uexp',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-uexp',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:20,stop:17},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-globet',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-globet',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:10,stop:8},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-verifieds',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-verifieds',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-gempost',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-gempost',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:0},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-peoplesp',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-peoplesp',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:200,stop:181},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-rulerm',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-rulerm',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:5,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-marketeer',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-marketeer',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:10,stop:7},invertedProgress:true,linkText:true,linkUnits:'items',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-tycoon',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-tycoon',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:32},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-mightiers',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-mightiers',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:50,stop:26},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-phantom',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-phantom',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-forumsf',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-forumsf',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:20,stop:13},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-fcultivator',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-fcultivator',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:33},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-splanner',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-splanner',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:25,stop:9},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-collector',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-collector',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:5,stop:2},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-prophoto',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-prophoto',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:500,stop:24},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-rmachine',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-rmachine',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:50,stop:41},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-bronzec',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-bronzec',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-silverc',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-silverc',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-goldc',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-goldc',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-platinumc',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#badge-platinumc',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:1,stop:0},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});/*-------------------
    QUEST PREVIEW
-------------------*/plugins.createProgressBar({container:'#quest-preview-nth',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-preview-nth',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:65},animateOnScroll:true});plugins.createProgressBar({container:'#quest-preview-sk',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-preview-sk',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:85},animateOnScroll:true});plugins.createProgressBar({container:'#quest-preview-bp',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-preview-bp',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:32},animateOnScroll:true});plugins.createProgressBar({container:'#quest-preview-htp',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-preview-htp',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:0},animateOnScroll:true});plugins.createProgressBar({container:'#quest-preview-sm',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-preview-sm',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:49},animateOnScroll:true});plugins.createProgressBar({container:'#quest-sk',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-sk',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:8,stop:7},linkText:true,linkUnits:'/'});plugins.createProgressBar({container:'#quest-fu',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-fu',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:50,stop:50},linkText:true,linkUnits:'/'});plugins.createProgressBar({container:'#quest-nth',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-nth',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:67},linkText:true,linkUnits:'%'});plugins.createProgressBar({container:'#quest-sm',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-sm',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:10,stop:5},linkText:true,linkUnits:'/'});plugins.createProgressBar({container:'#quest-line-ps',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-line-ps',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:100},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-nth',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-line-nth',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:67},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-fu',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-line-fu',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:50,stop:50},linkText:true,linkUnits:'/',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-ph',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-line-ph',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:20,stop:20},linkText:true,linkUnits:'/',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-tr',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-line-tr',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:10,stop:2},linkText:true,linkUnits:'/',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-sk',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-line-sk',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:8,stop:7},linkText:true,linkUnits:'/',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-bp',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-line-bp',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:30,stop:12},linkText:true,linkUnits:'/',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-htp',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-line-htp',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:0},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-sm',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#quest-line-sm',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:10,stop:5},linkText:true,linkUnits:'/',animateOnScroll:true});/*------------------
    POLL RESULT
------------------*/plugins.createProgressBar({container:'#poll-result-1',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#poll-result-1',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:62},linkText:true,linkUnits:'%'});plugins.createProgressBar({container:'#poll-result-2',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#poll-result-2',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:27},linkText:true,linkUnits:'%'});plugins.createProgressBar({container:'#poll-result-3',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#poll-result-3',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:11},linkText:true,linkUnits:'%'});/*---------------------
    POST ENGAGEMENT
---------------------*/plugins.createProgressBar({container:'#post-engagement-1',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#post-engagement-1',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:89},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#post-engagement-2',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#post-engagement-2',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:74},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#post-engagement-3',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#post-engagement-3',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:53},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#post-engagement-4',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#post-engagement-4',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:48},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#post-engagement-5',height:4,lineColor:'#293249'});plugins.createProgressBar({container:'#post-engagement-5',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:21},linkText:true,linkUnits:'%',animateOnScroll:true});/*-----------------
    TOP COUNTRY
-----------------*/plugins.createProgressBar({container:'#top-country-1',width:178,height:6,lineColor:'#293249'});plugins.createProgressBar({container:'#top-country-1',width:178,height:6,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:25362,stop:25362},split:{parts:30,gap:2,color:'#1d2333'},linkText:true,linkUnits:false,animateOnScroll:true});plugins.createProgressBar({container:'#top-country-2',width:178,height:6,lineColor:'#293249'});plugins.createProgressBar({container:'#top-country-2',width:178,height:6,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:25362,stop:18201},split:{parts:30,gap:2,color:'#1d2333'},linkText:true,linkUnits:false,animateOnScroll:true});plugins.createProgressBar({container:'#top-country-3',width:178,height:6,lineColor:'#293249'});plugins.createProgressBar({container:'#top-country-3',width:178,height:6,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:25362,stop:9567},split:{parts:30,gap:2,color:'#1d2333'},linkText:true,linkUnits:false,animateOnScroll:true});

},{"../utils/plugins":72}],51:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins');/*---------------------
    PROFILE HEADER 
---------------------*/plugins.createSlider({container:'#profile-header-social-links-slider',items:4,fixedWidth:32,gutter:8,loop:false,nav:false,controlsContainer:'#profile-header-social-links-slider-controls',responsive:{481:{fixedWidth:40,gutter:12}}});/*-------------------------
    SECTION NAVIGATION
-------------------------*/plugins.createSlider({container:'#section-navigation-slider',fixedWidth:122,nav:false,loop:false,controlsContainer:'#section-navigation-slider-controls'});/*-------------------------
    SECTION NAVIGATION
-------------------------*/plugins.createSlider({container:'#section-navigation-medium-slider',fixedWidth:160,nav:false,loop:false,controlsContainer:'#section-navigation-medium-slider-controls'});/*------------------------
    USER STATS SLIDER
------------------------*/plugins.createSlider({container:'#user-stats-slider',fixedWidth:113,nav:false,loop:false,controlsContainer:'#user-stats-slider-controls'});/*---------------------------
    REACTION STATS SLIDER
---------------------------*/plugins.createSlider({container:'#reaction-stats-slider',fixedWidth:146,nav:false,loop:false,controlsContainer:'#reaction-stats-slider-controls'});/*---------------------------
    STAT BLOCK SLIDER
---------------------------*/plugins.createSlider({container:'#stat-block-slider',fixedWidth:272,nav:false,loop:false,controlsContainer:'#stat-block-slider-controls'});/*-------------------
    STREAM SLIDER
-------------------*/plugins.createSlider({container:'#stream-slider',fixedWidth:184,gutter:16,nav:false,controlsContainer:'#stream-slider-controls'});/*----------------
    STATS BOX
----------------*/plugins.createSlider({container:'#stats-box-slider-items',mode:'gallery',nav:false,speed:1000,autoplay:true,autoplayButtonOutput:false,controlsContainer:'#stats-box-slider-controls'});/*--------------------
    REACTION STAT
--------------------*/plugins.createSlider({container:'#reaction-stat-slider-items',nav:false,speed:600,controlsContainer:'#reaction-stat-slider-controls'});/*-----------------
    BADGE STAT
-----------------*/plugins.createSlider({container:'#badge-stat-slider-items',nav:false,loop:false,speed:600,controlsContainer:'#badge-stat-slider-controls'});/*-------------------
    PRODUCT BOX
-------------------*/plugins.createSlider({container:'#product-box-slider-items',mode:'gallery',speed:1000,autoplay:true,autoplayButtonOutput:false,controlsContainer:'#product-box-slider-controls',navContainer:'#product-box-slider-roster'});/*-------------------------
    USER PREVIEW STATS 
-------------------------*/var createUserPreviewStatsSliders=function createUserPreviewStatsSliders(){var i=1;while(true){var j=i<10?"0".concat(i):i;var upStatsSlider=plugins.createSlider({container:"#user-preview-stats-slides-".concat(j),loop:false,controls:false,navContainer:"#user-preview-stats-roster-".concat(j)});if(!upStatsSlider)break;i++;}};createUserPreviewStatsSliders();var centerTinySlider=function centerTinySlider(sliderInfo,itemWidth,gutterWidth){sliderInfo.container.style.width="".concat(sliderInfo.slideCount*itemWidth+(sliderInfo.slideCount-1)*gutterWidth,"px");};/*--------------------------------
    USER PREVIEW SOCIAL LINKS
--------------------------------*/var createUserPreviewSocialLinksSliders=function createUserPreviewSocialLinksSliders(){var i=1;while(true){var j=i<10?"0".concat(i):i;var upSocialLinkSlider=plugins.createSlider({container:"#user-preview-social-links-slider-".concat(j),items:4,fixedWidth:32,gutter:8,loop:false,nav:false,controlsContainer:"#user-preview-social-links-slider-controls-".concat(j)});if(!upSocialLinkSlider)break;centerTinySlider(upSocialLinkSlider.getInfo(),32,8);i++;}};createUserPreviewSocialLinksSliders();

},{"../utils/plugins":72}],52:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins');plugins.createTab({triggers:'.tab-box-option',elements:'.tab-box-item'});

},{"../utils/plugins":72}],53:[function(require,module,exports){
"use strict";function _createForOfIteratorHelper(o,allowArrayLike){var it=typeof Symbol!=="undefined"&&o[Symbol.iterator]||o["@@iterator"];if(!it){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&typeof o.length==="number"){if(it)o=it;var i=0;var F=function F(){};return{s:F,n:function n(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]};},e:function e(_e){throw _e;},f:F};}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion=true,didErr=false,err;return{s:function s(){it=it.call(o);},n:function n(){var step=it.next();normalCompletion=step.done;return step;},e:function e(_e2){didErr=true;err=_e2;},f:function f(){try{if(!normalCompletion&&it["return"]!=null)it["return"]();}finally{if(didErr)throw err;}}};}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}var app=require('../utils/core');app.querySelector('.form-counter',function(counters){var _iterator=_createForOfIteratorHelper(counters),_step;try{var _loop=function _loop(){var counter=_step.value;var value=counter.querySelector('.form-counter-value'),increaseButton=counter.querySelector('.form-counter-control-increase'),decreaseButton=counter.querySelector('.form-counter-control-decrease'),increaseBy=counter.getAttribute('data-increase-by')?Number.parseInt(counter.getAttribute('data-increase-by'),10):1,minValue=counter.getAttribute('data-min')?Number.parseInt(counter.getAttribute('data-min'),10):1;var increaseValue=function increaseValue(){value.innerHTML=Number.parseInt(value.innerHTML,10)+increaseBy;};var decreaseValue=function decreaseValue(){if(Number.parseInt(value.innerHTML)===minValue)return;value.innerHTML=Number.parseInt(value.innerHTML,10)-increaseBy;};increaseButton.addEventListener('click',increaseValue);decreaseButton.addEventListener('click',decreaseValue);};for(_iterator.s();!(_step=_iterator.n()).done;){_loop();}}catch(err){_iterator.e(err);}finally{_iterator.f();}});

},{"../utils/core":69}],54:[function(require,module,exports){
"use strict";function _createForOfIteratorHelper(o,allowArrayLike){var it=typeof Symbol!=="undefined"&&o[Symbol.iterator]||o["@@iterator"];if(!it){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&typeof o.length==="number"){if(it)o=it;var i=0;var F=function F(){};return{s:F,n:function n(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]};},e:function e(_e){throw _e;},f:F};}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion=true,didErr=false,err;return{s:function s(){it=it.call(o);},n:function n(){var step=it.next();normalCompletion=step.done;return step;},e:function e(_e2){didErr=true;err=_e2;},f:function f(){try{if(!normalCompletion&&it["return"]!=null)it["return"]();}finally{if(didErr)throw err;}}};}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}var app=require('../utils/core');app.querySelector('.form-input',function(elements){var _iterator=_createForOfIteratorHelper(elements),_step;try{var _loop=function _loop(){var el=_step.value;if(el.classList.contains('always-active'))return"continue";var input=el.querySelector('input'),textarea=el.querySelector('textarea'),activeClass='active';var inputItem=undefined;if(input)inputItem=input;if(textarea)inputItem=textarea;if(inputItem){inputItem.addEventListener('focus',function(){el.classList.add(activeClass);});inputItem.addEventListener('blur',function(){if(inputItem.value===''){el.classList.remove(activeClass);}});}};for(_iterator.s();!(_step=_iterator.n()).done;){var _ret=_loop();if(_ret==="continue")continue;}}catch(err){_iterator.e(err);}finally{_iterator.f();}});

},{"../utils/core":69}],55:[function(require,module,exports){
"use strict";function _createForOfIteratorHelper(o,allowArrayLike){var it=typeof Symbol!=="undefined"&&o[Symbol.iterator]||o["@@iterator"];if(!it){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&typeof o.length==="number"){if(it)o=it;var i=0;var F=function F(){};return{s:F,n:function n(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]};},e:function e(_e){throw _e;},f:F};}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion=true,didErr=false,err;return{s:function s(){it=it.call(o);},n:function n(){var step=it.next();normalCompletion=step.done;return step;},e:function e(_e2){didErr=true;err=_e2;},f:function f(){try{if(!normalCompletion&&it["return"]!=null)it["return"]();}finally{if(didErr)throw err;}}};}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}var app=require('../utils/core');app.querySelector('.form-rating',function(ratingInputs){var _iterator=_createForOfIteratorHelper(ratingInputs),_step;try{var _loop=function _loop(){var ratingInput=_step.value;var filledClass='filled',ratingItems=Array.from(ratingInput.children);var getStarsRating=function getStarsRating(){var rating=0;var _iterator2=_createForOfIteratorHelper(ratingItems),_step2;try{for(_iterator2.s();!(_step2=_iterator2.n()).done;){var ratingItem=_step2.value;if(ratingItem.classList.contains(filledClass)){rating++;}}}catch(err){_iterator2.e(err);}finally{_iterator2.f();}return rating;};var setStarsRating=function setStarsRating(){ratingInput.setAttribute('data-rating',getStarsRating());};var fillStar=function fillStar(item){item.classList.add(filledClass);};var emptyStar=function emptyStar(item){item.classList.remove(filledClass);};var toggleStars=function toggleStars(){var itemIndex=ratingItems.indexOf(this);for(var i=0;i<=itemIndex;i++){fillStar(ratingItems[i]);}for(var _i=itemIndex+1;_i<ratingItems.length;_i++){emptyStar(ratingItems[_i]);}setStarsRating();};for(var _i2=0,_ratingItems=ratingItems;_i2<_ratingItems.length;_i2++){var ratingItem=_ratingItems[_i2];ratingItem.addEventListener('click',toggleStars);}setStarsRating();};for(_iterator.s();!(_step=_iterator.n()).done;){_loop();}}catch(err){_iterator.e(err);}finally{_iterator.f();}});

},{"../utils/core":69}],56:[function(require,module,exports){
"use strict";function _createForOfIteratorHelper(o,allowArrayLike){var it=typeof Symbol!=="undefined"&&o[Symbol.iterator]||o["@@iterator"];if(!it){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&typeof o.length==="number"){if(it)o=it;var i=0;var F=function F(){};return{s:F,n:function n(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]};},e:function e(_e){throw _e;},f:F};}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion=true,didErr=false,err;return{s:function s(){it=it.call(o);},n:function n(){var step=it.next();normalCompletion=step.done;return step;},e:function e(_e2){didErr=true;err=_e2;},f:function f(){try{if(!normalCompletion&&it["return"]!=null)it["return"]();}finally{if(didErr)throw err;}}};}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}var app=require('../utils/core');app.querySelector('.form-switch',function(switchInputs){var _iterator=_createForOfIteratorHelper(switchInputs),_step;try{var _loop=function _loop(){var switchInput=_step.value;var toggleSwitch=function toggleSwitch(){switchInput.classList.toggle('active');};switchInput.addEventListener('click',toggleSwitch);};for(_iterator.s();!(_step=_iterator.n()).done;){_loop();}}catch(err){_iterator.e(err);}finally{_iterator.f();}});

},{"../utils/core":69}],57:[function(require,module,exports){
"use strict";function _createForOfIteratorHelper(o,allowArrayLike){var it=typeof Symbol!=="undefined"&&o[Symbol.iterator]||o["@@iterator"];if(!it){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&typeof o.length==="number"){if(it)o=it;var i=0;var F=function F(){};return{s:F,n:function n(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]};},e:function e(_e){throw _e;},f:F};}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion=true,didErr=false,err;return{s:function s(){it=it.call(o);},n:function n(){var step=it.next();normalCompletion=step.done;return step;},e:function e(_e2){didErr=true;err=_e2;},f:function f(){try{if(!normalCompletion&&it["return"]!=null)it["return"]();}finally{if(didErr)throw err;}}};}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}var app=require('../utils/core');app.querySelector('.interactive-input',function(elements){var _iterator=_createForOfIteratorHelper(elements),_step;try{var _loop=function _loop(){var el=_step.value;var input=el.querySelector('input'),inputResetIcon=el.querySelector('.interactive-input-action'),activeClass='active';if(input){var previousValue='';var resetInputOnKey=function resetInputOnKey(e){// ESC key pressed
if(e.keyCode===27){input.value='';setActiveClass();window.removeEventListener('keydown',resetInputOnKey);}};var setActiveClass=function setActiveClass(){if(previousValue===''&&input.value!==''){el.classList.add(activeClass);window.addEventListener('keydown',resetInputOnKey);}else if(input.value===''){el.classList.remove(activeClass);window.removeEventListener('keydown',resetInputOnKey);}};input.addEventListener('input',setActiveClass);if(inputResetIcon){inputResetIcon.addEventListener('click',function(){input.value='';input.focus();setActiveClass();});}}};for(_iterator.s();!(_step=_iterator.n()).done;){_loop();}}catch(err){_iterator.e(err);}finally{_iterator.f();}});

},{"../utils/core":69}],58:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins');plugins.createAccordion({triggerSelector:'.accordion-trigger',contentSelector:'.accordion-content',startOpenClass:'accordion-open',selectedClass:'selected',linkTriggers:false});plugins.createAccordion({triggerSelector:'.accordion-trigger-linked',contentSelector:'.accordion-content-linked',startOpenClass:'accordion-open',selectedClass:'selected',linkTriggers:true});

},{"../utils/plugins":72}],59:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins'),app=require('../utils/core');var getLabelNumbers=function getLabelNumbers(count){var labels=[];for(var i=1;i<=count;i++){var label=i<10?"0".concat(i):i.toString();labels.push(label);}return labels;};var getCompleterData=function getCompleterData(datasetsData,maxValue){var completerData=new Array(datasetsData[0].length).fill(maxValue);for(var i=0;i<datasetsData.length;i++){for(var j=0;j<datasetsData[i].length;j++){completerData[j]-=datasetsData[i][j];}}return completerData;};/*------------------------
    ENGAGEMENTS CHART
------------------------*/app.querySelector('#engagements-chart',function(el){var canvas=el[0],ctx=canvas.getContext('2d'),chartData={datasets:[{data:[18.3,5.2,1.4,3.9],backgroundColor:['#7750f8','#4ff461','#08b8f1','#00e2cb'],hoverBackgroundColor:['#7750f8','#4ff461','#08b8f1','#00e2cb'],borderWidth:0}],labels:['Reactions','Comments','Shares','Replies']},chartOptions={cutoutPercentage:88,responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",callbacks:{label:function label(tooltipItem,data){var labelText=data.datasets[0].data[tooltipItem.index]+'K';return labelText;}}}};plugins.createChart(ctx,{type:'doughnut',data:chartData,options:chartOptions});});/*-------------------------------------
    VE MONTHLY REPORT RATIO CHART
-------------------------------------*/app.querySelector('#ve-monthly-report-ratio-chart',function(el){var canvas=el[0],ctx=canvas.getContext('2d'),chartData={datasets:[{data:[12.5,87.5],backgroundColor:['#7750f8','#4ff461'],hoverBackgroundColor:['#7750f8','#4ff461'],borderWidth:0}],labels:['Engagements','Visits']},chartOptions={cutoutPercentage:74,responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",callbacks:{label:function label(tooltipItem,data){var labelText=data.datasets[0].data[tooltipItem.index]+'%';return labelText;}}}};plugins.createChart(ctx,{type:'doughnut',data:chartData,options:chartOptions});});/*-------------------------------
    PROFILE COMPLETION CHART
-------------------------------*/app.querySelector('#profile-completion-chart',function(el){var canvas=el[0],ctx=canvas.getContext('2d'),gradient=ctx.createLinearGradient(0,70,140,70);gradient.addColorStop(0,'#d9ff65');gradient.addColorStop(1,'#40d04f');var chartData={datasets:[{data:[59,41],backgroundColor:[gradient,'#293249'],hoverBackgroundColor:[gradient,'#293249'],borderWidth:0}]},chartOptions={cutoutPercentage:88,responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{enabled:false},animation:{animateRotate:false}};plugins.createChart(ctx,{type:'doughnut',data:chartData,options:chartOptions});});/*-----------------------------
    POSTS ENGAGEMENT CHART
-----------------------------*/app.querySelector('#posts-engagement-chart',function(el){var canvas=el[0],ctx=canvas.getContext('2d'),gradient=ctx.createLinearGradient(0,40,80,40);gradient.addColorStop(0,'#41efff');gradient.addColorStop(1,'#615dfa');var chartData={datasets:[{data:[87,13],backgroundColor:[gradient,'#e8e8ef'],hoverBackgroundColor:[gradient,'#e8e8ef'],borderWidth:0}]},chartOptions={cutoutPercentage:85,responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{enabled:false},animation:{animateRotate:false}};plugins.createChart(ctx,{type:'doughnut',data:chartData,options:chartOptions});});/*-------------------------
    POSTS SHARED CHART
-------------------------*/app.querySelector('#posts-shared-chart',function(el){var canvas=el[0],ctx=canvas.getContext('2d'),gradient=ctx.createLinearGradient(0,40,80,40);gradient.addColorStop(0,'#41efff');gradient.addColorStop(1,'#615dfa');var chartData={datasets:[{data:[42,58],backgroundColor:[gradient,'#e8e8ef'],hoverBackgroundColor:[gradient,'#e8e8ef'],borderWidth:0}]},chartOptions={cutoutPercentage:85,responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{enabled:false},animation:{animateRotate:false}};plugins.createChart(ctx,{type:'doughnut',data:chartData,options:chartOptions});});/*------------------------------
    VE MONTHLY REPORT CHART
------------------------------*/app.querySelector('#ve-monthly-report-chart',function(el){var datasetData1=[20,15,22,26,12,16,24,13,17,9,26,21,14,21,17,23,30,18,24,15,28,17,13,23,16,12,23,16,24,13,22],datasetData2=[9,28,6,9,17,7,16,12,10,11,12,3,13,11,8,17,13,16,5,19,14,11,26,8,4,15,16,25,5,13,12],canvas=el[0],ctx=canvas.getContext('2d'),chartData={labels:getLabelNumbers(31),datasets:[{label:'Engagements',data:datasetData1,maxBarThickness:16,backgroundColor:'#7750f8'},{label:'Visits',data:datasetData2,maxBarThickness:16,backgroundColor:'#4ff461'},{data:getCompleterData([datasetData1,datasetData2],55),maxBarThickness:16,backgroundColor:'#2f3749'}]},chartOptions={responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",displayColors:false,callbacks:{title:function title(){}}},scales:{xAxes:[{stacked:true,gridLines:{display:false},ticks:{fontFamily:"'Rajdhani', sans-serif",fontColor:'#9aa4bf',fontSize:12,fontStyle:500}}],yAxes:[{stacked:true,gridLines:{color:"rgba(47, 55, 73, 1)",zeroLineColor:"rgba(47, 55, 73, 1)",drawBorder:false,drawTicks:false},ticks:{padding:20,fontFamily:"'Rajdhani', sans-serif",fontColor:'#9aa4bf',fontSize:12,fontStyle:500,max:55,stepSize:5}}]}};plugins.createChart(ctx,{type:'bar',data:chartData,options:chartOptions});});/*-----------------------------
    RC YEARLY REPORT CHART
-----------------------------*/app.querySelector('#rc-yearly-report-chart',function(el){var datasetData1=[119,142,110,122,163,139,143,110,141,121,139,190],datasetData2=[98,65,132,78,112,82,100,80,100,58,48,139],canvas=el[0],ctx=canvas.getContext('2d'),chartData={labels:['January','February','March','April','May','June','July','August','September','October','November','December'],datasets:[{label:'Reactions',data:datasetData1,fill:false,lineTension:0,borderWidth:4,borderColor:"#4ff461",borderCapStyle:'butt',borderDash:[],borderDashOffset:0,borderJoinStyle:'bevel',pointBorderColor:"#4ff461",pointBackgroundColor:"#1d2333",pointBorderWidth:4,pointHoverRadius:5,pointHoverBackgroundColor:"#1d2333",pointHoverBorderColor:"#4ff461",pointHoverBorderWidth:4,pointRadius:5,pointHitRadius:10},{label:'Comments',data:datasetData2,fill:false,lineTension:0,borderWidth:4,borderColor:"#08b8f1",borderCapStyle:'bevel',borderDash:[],borderDashOffset:0,borderJoinStyle:'bevel',pointBorderColor:"#08b8f1",pointBackgroundColor:"#1d2333",pointBorderWidth:4,pointHoverRadius:5,pointHoverBackgroundColor:"#1d2333",pointHoverBorderColor:"#08b8f1",pointHoverBorderWidth:4,pointRadius:5,pointHitRadius:10}]},chartOptions={responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",displayColors:false,callbacks:{title:function title(){}}},scales:{xAxes:[{gridLines:{color:"rgba(47, 55, 73, 1)",zeroLineColor:"rgba(47, 55, 73, 1)",drawBorder:false,drawTicks:false},ticks:{padding:14,fontFamily:"'Rajdhani', sans-serif",fontColor:'#9aa4bf',fontSize:12,fontStyle:500}}],yAxes:[{gridLines:{color:"rgba(47, 55, 73, 1)",zeroLineColor:"rgba(47, 55, 73, 1)",drawBorder:false},ticks:{padding:20,fontFamily:"'Rajdhani', sans-serif",fontColor:'#9aa4bf',fontSize:12,fontStyle:500,min:20,max:220,stepSize:40}}]}};plugins.createChart(ctx,{type:'line',data:chartData,options:chartOptions});});/*---------------------------
    VS PERFORMANCE CHART
---------------------------*/app.querySelector('#vs-performance-chart',function(el){var datasetData1=[140,90,155,180],datasetData2=[120,25,130,110],canvas=el[0],ctx=canvas.getContext('2d'),chartData={labels:['Aug','Sep','Oct','Nov'],datasets:[{label:'Views',data:datasetData1,maxBarThickness:16,backgroundColor:'#7750f8'},{label:'Sales',data:datasetData2,maxBarThickness:16,backgroundColor:'#4ff461'}]},chartOptions={responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",displayColors:false,callbacks:{title:function title(){}}},scales:{xAxes:[{gridLines:{display:false},ticks:{fontFamily:"'Rajdhani', sans-serif",fontColor:'#9aa4bf',fontSize:12,fontStyle:500}}],yAxes:[{gridLines:{display:false},ticks:{display:false}}]}};plugins.createChart(ctx,{type:'bar',data:chartData,options:chartOptions});});/*---------------------------
    EARNINGS REPORT CHART
---------------------------*/app.querySelector('#earnings-report-chart',function(el){var datasetData=[0,15,0,0,0,20,10,15,40,20,25,25,15,10,20,23,23,15,30,40,30,20,25,0,0,0,0,0,0,0,0,0],canvas=el[0],ctx=canvas.getContext('2d'),chartData={labels:getLabelNumbers(31),datasets:[{label:'Earnings',data:datasetData,lineTension:.5,borderWidth:2,backgroundColor:'rgba(79, 244, 97, .2)',borderColor:"#4ff461",borderCapStyle:'butt',borderDash:[],borderDashOffset:0,borderJoinStyle:'bevel',pointBorderColor:"#1d2333",pointBackgroundColor:"#4ff461",pointBorderWidth:2,pointHoverRadius:4,pointHoverBorderColor:"#1d2333",pointHoverBackgroundColor:"#4ff461",pointHoverBorderWidth:2,pointRadius:4,pointHitRadius:5}]},chartOptions={responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",displayColors:false,callbacks:{title:function title(){}}},scales:{xAxes:[{gridLines:{color:"rgba(47, 55, 73, 1)",zeroLineColor:"rgba(47, 55, 73, 1)",drawBorder:false,drawTicks:false},ticks:{padding:14,fontFamily:"'Rajdhani', sans-serif",fontColor:'#9aa4bf',fontSize:12,fontStyle:500}}],yAxes:[{gridLines:{color:"rgba(47, 55, 73, 1)",zeroLineColor:"rgba(47, 55, 73, 1)",drawBorder:false},ticks:{padding:20,fontFamily:"'Rajdhani', sans-serif",fontColor:'#9aa4bf',fontSize:12,fontStyle:500,max:55,stepSize:5,callback:function callback(value,index,values){return'$'+value;}}}]}};plugins.createChart(ctx,{type:'line',data:chartData,options:chartOptions});});/*---------------------------
    MEMBERS REPORT CHART
---------------------------*/app.querySelector('#members-report-chart',function(el){var datasetData=[8,4,8,5,10,13,11,11,13,17,5,12],canvas=el[0],ctx=canvas.getContext('2d'),chartData={labels:['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'],datasets:[{label:'Members',data:datasetData,lineTension:0,borderWidth:2,backgroundColor:'rgba(119, 80, 248, .1)',borderColor:"#7750f8",borderCapStyle:'butt',borderDash:[],borderDashOffset:0,borderJoinStyle:'bevel',pointBorderColor:"#7750f8",pointBackgroundColor:"#1d2333",pointBorderWidth:2,pointHoverRadius:4,pointHoverBorderColor:"#7750f8",pointHoverBackgroundColor:"#1d2333",pointHoverBorderWidth:2,pointRadius:4,pointHitRadius:5}]},chartOptions={responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",displayColors:false,callbacks:{title:function title(){}}},scales:{xAxes:[{gridLines:{color:"rgba(47, 55, 73, 1)",zeroLineColor:"rgba(47, 55, 73, 1)",drawBorder:false,drawTicks:false},ticks:{padding:14,fontFamily:"'Rajdhani', sans-serif",fontColor:'#9aa4bf',fontSize:12,fontStyle:500}}],yAxes:[{gridLines:{color:"rgba(47, 55, 73, 1)",zeroLineColor:"rgba(47, 55, 73, 1)",drawBorder:false},ticks:{padding:20,fontFamily:"'Rajdhani', sans-serif",fontColor:'#9aa4bf',fontSize:12,fontStyle:500,max:20,stepSize:2,beginAtZero:true}}]}};plugins.createChart(ctx,{type:'line',data:chartData,options:chartOptions});});

},{"../utils/core":69,"../utils/plugins":72}],60:[function(require,module,exports){
"use strict";window.initMap=function(){new google.maps.Map(document.getElementById('g-map'),{center:{lat:44.934084,lng:-93.252358},zoom:15,disableDefaultUI:false});};

},{}],61:[function(require,module,exports){
"use strict";var app=require('../utils/core');app.querySelector('.page-loader',function(el){var pageLoader=el[0];var hidePageLoader=function hidePageLoader(){pageLoader.classList.add('hidden');};window.addEventListener('load',hidePageLoader);});

},{"../utils/core":69}],62:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins'),app=require('../utils/core');plugins.createPopup({container:'.popup-video',trigger:'.popup-video-trigger',sticky:true,overlay:{color:'21, 21, 31',opacity:.96},animation:{type:'translate-in-fade',speed:.3,translateOffset:40}});plugins.createPopup({container:'.popup-picture',trigger:'.popup-picture-trigger',sticky:true,overlay:{color:'21, 21, 31',opacity:.96},animation:{type:'translate-in-fade',speed:.3,translateOffset:40}});plugins.createPopup({container:'.popup-album-creation',trigger:'.popup-album-creation-trigger',overlay:{color:'21, 21, 31',opacity:.96},animation:{type:'translate-in-fade',speed:.3,translateOffset:40}});plugins.createPopup({container:'.popup-event-creation',trigger:'.popup-event-creation-trigger',overlay:{color:'21, 21, 31',opacity:.96},animation:{type:'translate-in-fade',speed:.3,translateOffset:40}});plugins.createPopup({container:'.popup-event-information',trigger:'.popup-event-information-trigger',overlay:{color:'21, 21, 31',opacity:.96},animation:{type:'translate-in-fade',speed:.3,translateOffset:40}});plugins.createPopup({container:'.popup-create-group',trigger:'.popup-group-creation-trigger',overlay:{color:'21, 21, 31',opacity:.96},animation:{type:'translate-in-fade',speed:.3,translateOffset:40}});plugins.createPopup({container:'.popup-manage-group',trigger:'.popup-manage-group-trigger',overlay:{color:'21, 21, 31',opacity:.96},animation:{type:'translate-in-fade',speed:.3,translateOffset:40}});plugins.createPopup({container:'.popup-manage-item',trigger:'.popup-manage-item-trigger',overlay:{color:'21, 21, 31',opacity:.96},animation:{type:'translate-in-fade',speed:.3,translateOffset:40}});plugins.createPopup({container:'.popup-review',trigger:'.popup-review-trigger',overlay:{color:'21, 21, 31',opacity:.96},animation:{type:'translate-in-fade',speed:.3,translateOffset:40}});/*--------------------------
    PICTURE POPUP RESIZE
--------------------------*/app.querySelector('.popup-picture',function(el){var popup=el[0],widgetBoxScrollable=popup.querySelector('.widget-box-scrollable'),postCommentForm=popup.querySelector('.post-comment-form');var updateWidgetBoxScrollableDimensions=function updateWidgetBoxScrollableDimensions(){widgetBoxScrollable.style.height="".concat(popup.offsetHeight-postCommentForm.offsetHeight,"px");};updateWidgetBoxScrollableDimensions();window.addEventListener('resize',updateWidgetBoxScrollableDimensions);});

},{"../utils/core":69,"../utils/plugins":72}],63:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins');plugins.createTooltip({container:'.text-tooltip-tfr',offset:4,direction:'right',animation:{type:'translate-in-fade'}});plugins.createTooltip({container:'.text-tooltip-tft',offset:4,direction:'top',animation:{type:'translate-out-fade'}});plugins.createTooltip({container:'.text-tooltip-tft-medium',offset:8,direction:'top',animation:{type:'translate-out-fade'}});

},{"../utils/plugins":72}],64:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins');plugins.createHexagon({container:'.hexagon-148-164',width:148,height:164,roundedCorners:true,fill:true,lineColor:'#1d2333'});plugins.createHexagon({container:'.hexagon-progress-124-136',width:124,height:136,lineWidth:8,roundedCorners:true,gradient:{colors:['#d9ff65','#40d04f']},scale:{start:0,end:1,stop:.74}});plugins.createHexagon({container:'.hexagon-border-124-136',width:124,height:136,lineWidth:8,roundedCorners:true,lineColor:'#293249'});plugins.createHexagon({container:'.hexagon-image-100-110',width:100,height:110,roundedCorners:true,clip:true});plugins.createHexagon({container:'.hexagon-120-132',width:120,height:132,roundedCorners:true,fill:true,lineColor:'#1d2333'});plugins.createHexagon({container:'.hexagon-progress-100-110',width:100,height:110,lineWidth:6,roundedCorners:true,gradient:{colors:['#d9ff65','#40d04f']},scale:{start:0,end:1,stop:.8}});plugins.createHexagon({container:'.hexagon-border-100-110',width:100,height:110,lineWidth:6,roundedCorners:true,lineColor:'#293249'});plugins.createHexagon({container:'.hexagon-image-82-90',width:82,height:90,roundedCorners:true,roundedCornerRadius:3,clip:true});plugins.createHexagon({container:'.hexagon-100-110',width:100,height:110,roundedCorners:true,fill:true,lineColor:'#1d2333'});plugins.createHexagon({container:'.hexagon-progress-84-92',width:84,height:92,lineWidth:5,roundedCorners:true,roundedCornerRadius:3,gradient:{colors:['#d9ff65','#40d04f']},scale:{start:0,end:1,stop:.8}});plugins.createHexagon({container:'.hexagon-border-84-92',width:84,height:92,lineWidth:5,roundedCorners:true,roundedCornerRadius:3,lineColor:'#293249'});plugins.createHexagon({container:'.hexagon-image-68-74',width:68,height:74,roundedCorners:true,roundedCornerRadius:3,clip:true});plugins.createHexagon({container:'.hexagon-50-56',width:50,height:56,roundedCorners:true,roundedCornerRadius:2,fill:true,lineColor:'#1d2333'});plugins.createHexagon({container:'.hexagon-progress-40-44',width:40,height:44,lineWidth:3,roundedCorners:true,roundedCornerRadius:1,gradient:{colors:['#d9ff65','#40d04f']},scale:{start:0,end:1,stop:.8}});plugins.createHexagon({container:'.hexagon-border-40-44',width:40,height:44,lineWidth:3,roundedCorners:true,roundedCornerRadius:1,lineColor:'#293249'});plugins.createHexagon({container:'.hexagon-image-30-32',width:30,height:32,roundedCorners:true,roundedCornerRadius:1,clip:true});plugins.createHexagon({container:'.hexagon-40-44',width:40,height:44,roundedCorners:true,roundedCornerRadius:1,fill:true,lineColor:'#1d2333'});plugins.createHexagon({container:'.hexagon-dark-32-34',width:32,height:34,roundedCorners:true,roundedCornerRadius:1,lineColor:'#7750f8',fill:true});plugins.createHexagon({container:'.hexagon-32-36',width:32,height:36,roundedCorners:true,roundedCornerRadius:1,lineColor:'#1d2333',fill:true});plugins.createHexagon({container:'.hexagon-dark-26-28',width:26,height:28,roundedCorners:true,roundedCornerRadius:1,lineColor:'#7750f8',fill:true});plugins.createHexagon({container:'.hexagon-28-32',width:28,height:32,roundedCorners:true,roundedCornerRadius:1,lineColor:'#1d2333',fill:true});plugins.createHexagon({container:'.hexagon-dark-22-24',width:22,height:24,roundedCorners:true,roundedCornerRadius:1,lineColor:'#7750f8',fill:true});plugins.createHexagon({container:'.hexagon-22-24',width:22,height:24,roundedCorners:true,roundedCornerRadius:1,lineColor:'#1d2333',fill:true});plugins.createHexagon({container:'.hexagon-dark-16-18',width:16,height:18,roundedCorners:true,roundedCornerRadius:1,lineColor:'#7750f8',fill:true});plugins.createHexagon({container:'.hexagon-120-130',width:120,height:130,roundedCorners:true,fill:true,lineColor:'#1d2333'});plugins.createHexagon({container:'.hexagon-100-108',width:100,height:108,roundedCorners:true,fill:true,lineColor:'#1d2333'});plugins.createHexagon({container:'.hexagon-image-124-136',width:124,height:136,roundedCorners:true,clip:true});plugins.createHexagon({container:'.hexagon-image-84-92',width:84,height:92,roundedCorners:true,clip:true});plugins.createHexagon({container:'.hexagon-34-36',width:34,height:36,roundedCorners:true,roundedCornerRadius:1,fill:true,lineColor:'#1d2333'});plugins.createHexagon({container:'.hexagon-image-40-44',width:40,height:44,roundedCorners:true,roundedCornerRadius:1,clip:true});plugins.createHexagon({container:'.hexagon-image-24-26',width:24,height:26,roundedCorners:true,roundedCornerRadius:1,clip:true});plugins.createHexagon({container:'.hexagon-image-18-20',width:18,height:20,roundedCorners:true,roundedCornerRadius:1,clip:true});plugins.createHexagon({container:'.hexagon-overlay-30-32',width:30,height:32,roundedCorners:true,roundedCornerRadius:1,lineColor:'rgba(97, 93, 250, .9)',fill:true});

},{"../utils/plugins":72}],65:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins'),app=require('../utils/core');/*--------------------
    HEADER SEARCH
--------------------*/app.querySelector('#search-main',function(el){var headerSearchDropdown=plugins.createDropdown({container:'.header-search-dropdown',offset:{top:57,left:0},animation:{type:'translate-top'},controlToggle:true,closeOnWindowClick:false});var searchInput=el[0],breakpointWidth=960;var previousValue='';var hideSearchDropdownOnKey=function hideSearchDropdownOnKey(e){// ESC key pressed
if(e.keyCode===27){headerSearchDropdown.hideDropdowns();previousValue='';window.removeEventListener('keydown',hideSearchDropdownOnKey);}};var toggleSearchDropdown=function toggleSearchDropdown(e){if(previousValue===''&&e.target.value!==''){headerSearchDropdown.showDropdowns();window.addEventListener('keydown',hideSearchDropdownOnKey);}else if(e.target.value===''){headerSearchDropdown.hideDropdowns();window.removeEventListener('keydown',hideSearchDropdownOnKey);}previousValue=e.target.value;};var interactiveInputAction=searchInput.parentElement.querySelector('.interactive-input-action');var hideSearchDropdown=function hideSearchDropdown(){headerSearchDropdown.hideDropdowns();window.removeEventListener('keydown',hideSearchDropdownOnKey);previousValue='';};if(window.innerWidth>breakpointWidth){searchInput.addEventListener('input',toggleSearchDropdown);interactiveInputAction.addEventListener('click',hideSearchDropdown);}});/*----------------------
    HEADER DROPDOWNS
----------------------*/plugins.createDropdown({trigger:'.header-dropdown-trigger',container:'.header-dropdown',offset:{top:64,right:6},animation:{type:'translate-top'}});plugins.createDropdown({trigger:'.header-settings-dropdown-trigger',container:'.header-settings-dropdown',offset:{top:64,right:22},animation:{type:'translate-top'}});

},{"../utils/core":69,"../utils/plugins":72}],66:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins');plugins.createProgressBar({container:'#logged-user-level',height:4,lineColor:'#5538b5'});plugins.createProgressBar({container:'#logged-user-level',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:62},linkText:true,linkUnits:'exp',invertedProgress:true});plugins.createProgressBar({container:'#logged-user-level-cp',height:4,lineColor:'#5538b5'});plugins.createProgressBar({container:'#logged-user-level-cp',height:4,gradient:{colors:['#40d04f','#d9ff65']},scale:{start:0,end:100,stop:62},linkText:true,linkUnits:'exp',invertedProgress:true});

},{"../utils/plugins":72}],67:[function(require,module,exports){
"use strict";var plugins=require('../utils/plugins');plugins.createTab({triggers:'.login-register-form-trigger',elements:'.login-register-form-element',animation:{type:'slide-in-right'},onTabChange:function onTabChange(activeTab){var firstInput=activeTab.querySelector('input');firstInput.focus();}});

},{"../utils/plugins":72}],68:[function(require,module,exports){
"use strict";function _createForOfIteratorHelper(o,allowArrayLike){var it=typeof Symbol!=="undefined"&&o[Symbol.iterator]||o["@@iterator"];if(!it){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&typeof o.length==="number"){if(it)o=it;var i=0;var F=function F(){};return{s:F,n:function n(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]};},e:function e(_e){throw _e;},f:F};}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion=true,didErr=false,err;return{s:function s(){it=it.call(o);},n:function n(){var step=it.next();normalCompletion=step.done;return step;},e:function e(_e2){didErr=true;err=_e2;},f:function f(){try{if(!normalCompletion&&it["return"]!=null)it["return"]();}finally{if(didErr)throw err;}}};}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}var app=require('../utils/core');/*-------------------
    CONTENT GRID 
-------------------*/app.querySelector('.content-grid',function(el){var sidebar={chat:{active:false,minWidth:80,maxWidth:300},navigation:{active:false,minWidth:80,maxWidth:300}},breakpointWidth=1366;var updateGridPosition=function updateGridPosition(contentGrid){if(window.innerWidth>breakpointWidth){var chatWidth=sidebar.chat.active?sidebar.chat.maxWidth:sidebar.chat.minWidth,navigationWidth=sidebar.navigation.active?sidebar.navigation.maxWidth:sidebar.navigation.minWidth,availableWidth=document.body.clientWidth-contentGrid.offsetWidth-chatWidth-navigationWidth,offsetX=availableWidth/2+navigationWidth;contentGrid.style.transform="translate(".concat(offsetX,"px, 0)");}else{contentGrid.style.transform="translate(0, 0)";}};var updateGridPositions=function updateGridPositions(){var _iterator=_createForOfIteratorHelper(el),_step;try{for(_iterator.s();!(_step=_iterator.n()).done;){var grid=_step.value;updateGridPosition(grid);}}catch(err){_iterator.e(err);}finally{_iterator.f();}};var setGridTransition=function setGridTransition(grid){grid.style.transition="transform .4s ease-in-out";};var setGridTransitions=function setGridTransitions(){var _iterator2=_createForOfIteratorHelper(el),_step2;try{for(_iterator2.s();!(_step2=_iterator2.n()).done;){var grid=_step2.value;setGridTransition(grid);}}catch(err){_iterator2.e(err);}finally{_iterator2.f();}};updateGridPositions();window.addEventListener('resize',updateGridPositions);// delay transition setup to avoid loading animation
window.setTimeout(setGridTransitions,300);/*-------------------
      CHAT WIDGET 
  -------------------*/app.querySelector('#chat-widget-messages',function(el){var chatWidget=el[0],topOffset=80,closedWidth=80,openWidth=300,chatWidgetMessages=chatWidget.querySelector('.chat-widget-messages'),chatWidgetForm=chatWidget.querySelector('.chat-widget-form'),chatWidgetButton=chatWidget.querySelector('.chat-widget-button'),closedClass='closed';var setChatMessagesDimensions=function setChatMessagesDimensions(){if(chatWidget.classList.contains(closedClass)){chatWidgetMessages.style.height="".concat(window.innerHeight-chatWidgetButton.offsetHeight-topOffset,"px");}else{chatWidgetMessages.style.height="".concat(window.innerHeight-chatWidgetForm.offsetHeight-chatWidgetButton.offsetHeight-topOffset,"px");}};var toggleChatWidget=function toggleChatWidget(){chatWidget.classList.toggle(closedClass);setChatMessagesDimensions();sidebar.chat.active=!chatWidget.classList.contains(closedClass);updateGridPositions();};var openChatWidget=function openChatWidget(){chatWidget.classList.remove(closedClass);setChatMessagesDimensions();sidebar.chat.active=true;updateGridPositions();};chatWidgetButton.addEventListener('click',toggleChatWidget);setChatMessagesDimensions();window.addEventListener('resize',setChatMessagesDimensions);app.querySelector('#chat-widget-message',function(el){var chatMessageWidget=el[0],chatWidgetMessage=chatWidgetMessages.querySelectorAll('.chat-widget-message'),chatMessageWidgetHeader=chatMessageWidget.querySelector('.chat-widget-header'),chatMessageWidgetConversation=chatMessageWidget.querySelector('.chat-widget-conversation'),chatMessageWidgetCloseButton=chatMessageWidget.querySelector('.chat-widget-close-button'),hiddenClass='hidden';var setChatConversationDimensions=function setChatConversationDimensions(){chatMessageWidgetConversation.style.height="".concat(window.innerHeight-chatMessageWidgetHeader.offsetHeight-chatWidgetForm.offsetHeight-chatWidgetButton.offsetHeight-topOffset,"px");};var toggleChatMessageWidget=function toggleChatMessageWidget(){chatMessageWidget.classList.toggle(hiddenClass);};var closeChatMessageWidget=function closeChatMessageWidget(){chatMessageWidget.classList.add(hiddenClass);};var _iterator3=_createForOfIteratorHelper(chatWidgetMessage),_step3;try{for(_iterator3.s();!(_step3=_iterator3.n()).done;){var widgetMessage=_step3.value;widgetMessage.addEventListener('click',toggleChatMessageWidget);widgetMessage.addEventListener('click',openChatWidget);}}catch(err){_iterator3.e(err);}finally{_iterator3.f();}chatWidgetButton.addEventListener('click',closeChatMessageWidget);chatMessageWidgetCloseButton.addEventListener('click',toggleChatMessageWidget);setChatConversationDimensions();window.addEventListener('resize',setChatConversationDimensions);});});/*------------------------
      NAVIGATION WIDGET 
  ------------------------*/app.querySelector('.navigation-widget-trigger',function(el){var navigationTrigger=el[0],topOffset=80,navigationWidget=document.querySelector('#navigation-widget'),navigationWidgetSmall=document.querySelector('#navigation-widget-small'),activeClass='active',hiddenClass='hidden',delayedClass='delayed';var setNavigationWidgetDimensions=function setNavigationWidgetDimensions(){navigationWidget.style.height="".concat(window.innerHeight-topOffset,"px");};var toggleNavigationWidget=function toggleNavigationWidget(){navigationTrigger.classList.toggle(activeClass);navigationWidget.classList.toggle(delayedClass);navigationWidget.classList.toggle(hiddenClass);navigationWidgetSmall.classList.toggle(delayedClass);navigationWidgetSmall.classList.toggle(hiddenClass);sidebar.navigation.active=!navigationWidget.classList.contains(hiddenClass);updateGridPositions();};navigationTrigger.addEventListener('click',toggleNavigationWidget);setNavigationWidgetDimensions();window.addEventListener('resize',setNavigationWidgetDimensions);});/*-------------------------------
      NAVIGATION WIDGET MOBILE
  -------------------------------*/app.querySelector('.navigation-widget-mobile-trigger',function(el){var navigationMobileTrigger=el[0],navigationWidgetMobile=document.querySelector('#navigation-widget-mobile'),navigationWidgetMobileCloseButton=navigationWidgetMobile.querySelector('.navigation-widget-close-button'),hiddenClass='hidden';var overlay=document.createElement('div');overlay.style.width='100%';overlay.style.height='100%';overlay.style.position='fixed';overlay.style.top='0';overlay.style.left='0';overlay.style.zIndex=99998;overlay.style.backgroundColor='rgba(21, 21, 31, .96)';overlay.style.opacity=0;overlay.style.visibility='hidden';overlay.style.transition='opacity .3s ease-in-out, visibility .3s ease-in-out';document.body.appendChild(overlay);var showOverlay=function showOverlay(){overlay.style.opacity=1;overlay.style.visibility='visible';};var hideOverlay=function hideOverlay(){overlay.style.opacity=0;overlay.style.visibility='hidden';};var setNavigationWidgetMobileDimensions=function setNavigationWidgetMobileDimensions(){navigationWidgetMobile.style.height="".concat(window.innerHeight,"px");};var toggleNavigationWidgetMobile=function toggleNavigationWidgetMobile(){navigationWidgetMobile.classList.toggle(hiddenClass);var toggleOverlay=navigationWidgetMobile.classList.contains(hiddenClass)?hideOverlay:showOverlay;toggleOverlay();};navigationMobileTrigger.addEventListener('click',toggleNavigationWidgetMobile);navigationWidgetMobileCloseButton.addEventListener('click',toggleNavigationWidgetMobile);overlay.addEventListener('click',toggleNavigationWidgetMobile);setNavigationWidgetMobileDimensions();window.addEventListener('resize',setNavigationWidgetMobileDimensions);});});

},{"../utils/core":69}],69:[function(require,module,exports){
"use strict";function _typeof(obj){"@babel/helpers - typeof";if(typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"){_typeof=function _typeof(obj){return typeof obj;};}else{_typeof=function _typeof(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};}return _typeof(obj);}var app={deepExtend:function deepExtend(a,b){for(var prop in b){if(_typeof(b[prop])==='object'){a[prop]=b[prop]instanceof Array?[]:{};this.deepExtend(a[prop],b[prop]);}else{a[prop]=b[prop];}}},query:function query(options){var config={method:'GET',async:true,header:{type:'Content-type',value:'application/json'},data:''};this.deepExtend(config,options);return new Promise(function(resolve,reject){var xhttp=new XMLHttpRequest();xhttp.onreadystatechange=function(){if(xhttp.readyState!==4)return;if(xhttp.status===200){resolve(xhttp.responseText);}else{reject({status:xhttp.status,statusText:xhttp.statusText});}};xhttp.open(config.method,config.url,config.async);xhttp.setRequestHeader(config.header.type,config.header.value);if(config.method==='GET'){xhttp.send();}else if(config.method==='POST'){xhttp.send(config.data);}});},querySelector:function querySelector(selector,callback){var el=document.querySelectorAll(selector);if(el.length){callback(el);}},liquidify:function liquidify(el){var image=el.querySelector('img'),imageSrc=image.getAttribute('src');image.style.display='none';el.style.background="url(\"".concat(imageSrc,"\") no-repeat center");el.style.backgroundSize='cover';},liquidifyStatic:function liquidifyStatic(figure,image){image.style.display='none';figure.style.background="url(\"".concat(image.getAttribute('src'),"\") no-repeat center");figure.style.backgroundSize='cover';},dateDiff:function dateDiff(date1){var date2=arguments.length>1&&arguments[1]!==undefined?arguments[1]:new Date();var timeDiff=Math.abs(date1.getTime()-date2.getTime()),secondsDiff=Math.ceil(timeDiff/1000),minutesDiff=Math.floor(timeDiff/(1000*60)),hoursDiff=Math.floor(timeDiff/(1000*60*60)),daysDiff=Math.floor(timeDiff/(1000*60*60*24)),weeksDiff=Math.floor(timeDiff/(1000*60*60*24*7)),monthsDiff=Math.floor(timeDiff/(1000*60*60*24*7*4)),yearsDiff=Math.floor(timeDiff/(1000*60*60*24*7*4*12));var unit;if(secondsDiff<60){unit=secondsDiff===1?'second':'seconds';return{unit:unit,value:secondsDiff};}else if(minutesDiff<60){unit=minutesDiff===1?'minute':'minutes';return{unit:unit,value:minutesDiff};}else if(hoursDiff<24){unit=hoursDiff===1?'hour':'hours';return{unit:unit,value:hoursDiff};}else if(daysDiff<7){unit=daysDiff===1?'day':'days';return{unit:unit,value:daysDiff};}else if(weeksDiff<4){unit=weeksDiff===1?'week':'weeks';return{unit:unit,value:weeksDiff};}else if(monthsDiff<12){unit=monthsDiff===1?'month':'months';return{unit:unit,value:monthsDiff};}else{unit=yearsDiff===1?'year':'years';return{unit:unit,value:yearsDiff};}}};module.exports=app;

},{}],70:[function(require,module,exports){
"use strict";function _createForOfIteratorHelper(o,allowArrayLike){var it=typeof Symbol!=="undefined"&&o[Symbol.iterator]||o["@@iterator"];if(!it){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&typeof o.length==="number"){if(it)o=it;var i=0;var F=function F(){};return{s:F,n:function n(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]};},e:function e(_e){throw _e;},f:F};}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion=true,didErr=false,err;return{s:function s(){it=it.call(o);},n:function n(){var step=it.next();normalCompletion=step.done;return step;},e:function e(_e2){didErr=true;err=_e2;},f:function f(){try{if(!normalCompletion&&it["return"]!=null)it["return"]();}finally{if(didErr)throw err;}}};}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}var app=require('./core');app.querySelector('.icon-demo-list',function(lists){var icons=[{name:'Facebook',className:'facebook'},{name:'Twitter',className:'twitter'},{name:'Twitch',className:'twitch'},{name:'Youtube',className:'youtube'},{name:'Instagram',className:'instagram'},{name:'Discord',className:'discord'},{name:'Patreon',className:'patreon'},{name:'Google',className:'google'},{name:'Behance',className:'behance'},{name:'DeviantArt',className:'deviantart'},{name:'Artstation',className:'artstation'},{name:'Cross',className:'cross'},{name:'Logo Vikinger',className:'logo-vikinger'},{name:'Grid',className:'grid'},{name:'Dots',className:'dots'},{name:'Magnifying Glass',className:'magnifying-glass'},{name:'Comment',className:'comment'},{name:'Thumbs Up',className:'thumbs-up'},{name:'Friend',className:'friend'},{name:'Group',className:'group'},{name:'Marketplace',className:'marketplace'},{name:'Add Friend',className:'add-friend'},{name:'Remove Friend',className:'remove-friend'},{name:'Delete',className:'delete'},{name:'Messages',className:'messages'},{name:'Send Message',className:'send-message'},{name:'Back Arrow',className:'back-arrow'},{name:'Shopping Bag',className:'shopping-bag'},{name:'Notification',className:'notification'},{name:'Settings',className:'settings'},{name:'Cross Thin',className:'cross-thin'},{name:'Newsfeed',className:'newsfeed'},{name:'Overview',className:'overview'},{name:'Members',className:'members'},{name:'Badges',className:'badges'},{name:'Quests',className:'quests'},{name:'Streams',className:'streams'},{name:'Events',className:'events'},{name:'Forums',className:'forums'},{name:'Small Arrow',className:'small-arrow'},{name:'Big Arrow',className:'big-arrow'},{name:'Public',className:'public'},{name:'Private',className:'private'},{name:'Join Group',className:'join-group'},{name:'Leave Group',className:'leave-group'},{name:'More Dots',className:'more-dots'},{name:'Profile',className:'profile'},{name:'Timeline',className:'timeline'},{name:'Photos',className:'photos'},{name:'Videos',className:'videos'},{name:'Blog Posts',className:'blog-posts'},{name:'Forum',className:'forum'},{name:'Store',className:'store'},{name:'Star',className:'star'},{name:'Play',className:'play'},{name:'Share',className:'share'},{name:'Pinned',className:'pinned'},{name:'Status',className:'status'},{name:'Big Grid View',className:'big-grid-view'},{name:'Small Grid View',className:'small-grid-view'},{name:'List Grid View',className:'list-grid-view'},{name:'Plus',className:'plus'},{name:'Plus Small',className:'plus-small'},{name:'Minus Small',className:'minus-small'},{name:'Poll',className:'poll'},{name:'Camera',className:'camera'},{name:'Gif',className:'gif'},{name:'Tags',className:'tags'},{name:'Quote',className:'quote'},{name:'Pin',className:'pin'},{name:'Ticket',className:'ticket'},{name:'Events Monthly',className:'events-monthly'},{name:'Events Weekly',className:'events-weekly'},{name:'Events Daily',className:'events-daily'},{name:'Info',className:'info'},{name:'Check',className:'check'},{name:'Trophy',className:'trophy'},{name:'Clock',className:'clock'},{name:'Return',className:'return'},{name:'Dribbble',className:'dribbble'},{name:'Item',className:'item'},{name:'Wallet',className:'wallet'},{name:'Earnings',className:'earnings'},{name:'Revenue',className:'revenue'},{name:'Login',className:'login'}];var createIcon=function createIcon(iconName){var svg=document.createElementNS('http://www.w3.org/2000/svg','svg'),use=document.createElementNS('http://www.w3.org/2000/svg','use');svg.classList.add("icon-".concat(iconName));use.setAttributeNS('http://www.w3.org/1999/xlink','xlink:href',"#svg-".concat(iconName));svg.appendChild(use);return svg;};var createIconString=function createIconString(icon){var iconString="\n    <!-- ICON ".concat(icon.name.toUpperCase()," -->\n    <svg class=\"icon-").concat(icon.className,"\">\n      <use xlink:href=\"#svg-").concat(icon.className,"\"></use>\n    </svg>\n    <!-- /ICON ").concat(icon.name.toUpperCase()," -->");return iconString;};var createDemoIconString=function createDemoIconString(icon){var iconString="\n    <!-- ICON ".concat(icon.name.toUpperCase()," -->\n    <svg class=\"icon-").concat(icon.className," demo-icon\">\n      <use xlink:href=\"#svg-").concat(icon.className,"\"></use>\n    </svg>\n    <!-- /ICON ").concat(icon.name.toUpperCase()," -->");return iconString;};var createDemoBox=function createDemoBox(iconData){var container=document.createElement('div'),iconContainer=document.createElement('div'),icon=createIcon(iconData.className),title=document.createElement('p'),text=document.createElement('p'),button=document.createElement('p'),buttonInactiveText=document.createElement('span'),buttonActiveText=document.createElement('span');container.classList.add('demo-box');iconContainer.classList.add('demo-box-icon-wrap');icon.classList.add('demo-box-icon');title.classList.add('demo-box-title');text.classList.add('demo-box-text');button.classList.add('button','full');buttonInactiveText.classList.add('inactive-text');buttonActiveText.classList.add('active-text');title.innerHTML=iconData.name;text.innerHTML=".icon-".concat(iconData.className);buttonInactiveText.innerHTML='Copy SVG';buttonActiveText.innerHTML='Copied!';iconContainer.appendChild(icon);container.appendChild(iconContainer);container.appendChild(title);container.appendChild(text);button.appendChild(buttonInactiveText);button.appendChild(buttonActiveText);container.appendChild(button);return{container:container,trigger:button};};var copyCode=function copyCode(code){var input=document.createElement('textarea');input.innerHTML=code;document.body.appendChild(input);input.select();document.execCommand('copy');input.remove();};// ICON BACKLOG
var divWrap=document.createElement('div');divWrap.style.width='80px';divWrap.style.position='fixed';divWrap.style.top='80px';divWrap.style.left='0';document.body.appendChild(divWrap);var _iterator=_createForOfIteratorHelper(lists),_step;try{for(_iterator.s();!(_step=_iterator.n()).done;){var list=_step.value;// Sort icons array
var sortedIcons=icons.sort(function(firstEl,secondEl){if(firstEl.name<secondEl.name){return-1;}if(firstEl.name>secondEl.name){return 1;}return 0;});var _iterator2=_createForOfIteratorHelper(sortedIcons),_step2;try{var _loop=function _loop(){var icon=_step2.value;var demoBox=createDemoBox(icon);list.appendChild(demoBox.container);demoBox.trigger.addEventListener('click',function(){var iconCode=createIconString(icon);copyCode(iconCode);demoBox.trigger.classList.add('active');window.setTimeout(function(){demoBox.trigger.classList.remove('active');},2000);// ICON BACKLOG
var div=document.createElement('div');div.style.display='flex';div.style.justifyContent='center';div.style.marginTop='30px';div.innerHTML=createDemoIconString(icon);divWrap.appendChild(div);});};for(_iterator2.s();!(_step2=_iterator2.n()).done;){_loop();}}catch(err){_iterator2.e(err);}finally{_iterator2.f();}}}catch(err){_iterator.e(err);}finally{_iterator.f();}});

},{"./core":69}],71:[function(require,module,exports){
"use strict";function _createForOfIteratorHelper(o,allowArrayLike){var it=typeof Symbol!=="undefined"&&o[Symbol.iterator]||o["@@iterator"];if(!it){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&typeof o.length==="number"){if(it)o=it;var i=0;var F=function F(){};return{s:F,n:function n(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]};},e:function e(_e){throw _e;},f:F};}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion=true,didErr=false,err;return{s:function s(){it=it.call(o);},n:function n(){var step=it.next();normalCompletion=step.done;return step;},e:function e(_e2){didErr=true;err=_e2;},f:function f(){try{if(!normalCompletion&&it["return"]!=null)it["return"]();}finally{if(didErr)throw err;}}};}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}var app=require('../utils/core');app.querySelector('.liquid',function(images){var _iterator=_createForOfIteratorHelper(images),_step;try{for(_iterator.s();!(_step=_iterator.n()).done;){var image=_step.value;app.liquidify(image);}}catch(err){_iterator.e(err);}finally{_iterator.f();}});

},{"../utils/core":69}],72:[function(require,module,exports){
"use strict";var _tinySlider=require("tiny-slider/src/tiny-slider");var ChartJS=require('chart.js');var existsInDOM=function existsInDOM(selector){return document.querySelectorAll(selector).length;};var plugins={createTab:function createTab(options){if(existsInDOM(options.triggers)&&existsInDOM(options.elements)){return new XM_Tab(options);}},createHexagon:function createHexagon(options){if(existsInDOM(options.container)||typeof options.containerElement!=='undefined'){return new XM_Hexagon(options);}},createProgressBar:function createProgressBar(options){if(existsInDOM(options.container)){return new XM_ProgressBar(options);}},createDropdown:function createDropdown(options){if((existsInDOM(options.container)||typeof options.containerElement!=='undefined')&&options.controlToggle||(existsInDOM(options.trigger)||typeof options.triggerElement!=='undefined')&&(existsInDOM(options.container)||typeof options.containerElement!=='undefined')){return new XM_Dropdown(options);}},createTooltip:function createTooltip(options){if(existsInDOM(options.container)){return new XM_Tooltip(options);}},createSlider:function createSlider(options){if(existsInDOM(options.container)){return(0,_tinySlider.tns)(options);}},createPopup:function createPopup(options){if(existsInDOM(options.container)&&existsInDOM(options.trigger)){return new XM_Popup(options);}},createAccordion:function createAccordion(options){if(existsInDOM(options.triggerSelector)&&existsInDOM(options.contentSelector)){return new XM_Accordion(options);}},createChart:function createChart(ctx,options){return new ChartJS(ctx,options);}};module.exports=plugins;

},{"chart.js":1,"tiny-slider/src/tiny-slider":47}],73:[function(require,module,exports){
"use strict";var svgWrap=document.createElement('div'),svgData="\n  \n  <!-- SVG LOGO EOG -->\n    <svg style=\"display: none;\">\n        <symbol id=\"svg-logo-eog\" viewBox=\"0 0 28 40\" preserveAspectRatio=\"xMinYMin meet\">\n          <path d=\"M27.1,24c-0.1-0.1-0.2-0.1-0.2-0.1l0,0c-1.4-1.1-3.8-1.8-3.8-1.8c1.5,0,2.6-0.6,3.5-1.3c0-0.1,0.7-0.7,0.7-0.7\n          c0.1-8.3-4.5-12.7-7-14.7c-2.2,4.2-3.5,8.7-3.5,8.7C16.5,9.7,17,6.1,17.4,3.5c-0.4,0.1-0.8,0.2-1.2,0.2c-1.3,0-2.6,0.1-4-0.1\n          c-0.6-0.1-1.2-0.2-1.7-0.4c-0.1,0-0.1,0.1-0.2,0.1c0.5,2.6,0.9,6.2,0.7,10.7c0,0-1.3-4.4-3.5-8.7c-2.5,1.9-7.1,6.4-7,14.7\n          c0,0,0.7,0.6,0.7,0.7c0.9,0.8,2,1.3,3.5,1.3c0,0-2.4,0.8-3.8,1.8l0,0c0,0-0.1,0.1-0.2,0.1c-0.5,0.4-0.8,0.8-0.8,1.3\n          c0,0.5,0.3,1.2,1.2,2c0,0,0.1,9.3,9.7,11.3c0,0,0,0,1,0.2l2.1,0.4h1.2c1-0.1,1.8-0.3,1.8-0.3c9.6-2,9.8-11.6,9.8-11.6\n          c1-0.8,1.3-1.5,1.2-2C27.9,24.9,27.6,24.4,27.1,24z M4.1,26c2.4,0.1,3.5,1.5,5.6,4c0.8,1,2.1,0.8,2.1,0.8l0,3.2\n          C5.2,34,4.1,26,4.1,26z M16.1,34l0-3.2c0,0,1.3,0.1,2.1-0.8c2.1-2.5,3.2-3.9,5.6-4C23.8,26,22.7,34,16.1,34z\"/>\n        </symbol>\n    </svg>\n  <!-- FINE ICONA SVG LOGO EOG -->\n  \n  <!-- ICONA SVG FACEBOOK -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-facebook\" viewBox=\"0 0 18 18\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16.313,18h-4.504v-6.192h3.087V8.671h-3.087V7.135V6.831V6.814l0,0c0.01-0.328,0.277-0.591,0.607-0.591h0.067h1.113h1.62V3.086h-2.733l0,0l-0.009,0.018h-0.092c-2.051,0-3.712,1.661-3.712,3.711v0.911v0.945H6.191v3.137h2.479V18H1.687C0.755,18,0,17.242,0,16.313V1.686C0,0.754,0.755,0,1.687,0h14.626C17.244,0,18,0.754,18,1.686v14.627C18,17.242,17.244,18,16.313,18z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG FACEBOOK -->\n\n  <!-- SVG TWITTER -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-twitter\" viewBox=\"0 0 18 18\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M18,3.617c-0.675,0.322-1.351,0.43-2.139,0.537c0.788-0.43,1.351-1.076,1.576-1.937c-0.675,0.43-1.463,0.646-2.362,0.861C14.399,2.431,13.388,2,12.375,2c-1.912,0-3.601,1.617-3.601,3.554c0,0.323,0,0.538,0.113,0.754C5.851,6.2,3.038,4.8,1.238,2.646C0.9,3.185,0.788,3.724,0.788,4.478c0,1.184,0.675,2.261,1.688,2.907c-0.563,0-1.125-0.216-1.688-0.431l0,0c0,1.723,1.237,3.122,2.925,3.446c-0.338,0.107-0.675,0.107-1.013,0.107c-0.225,0-0.45,0-0.675-0.107c0.45,1.399,1.8,2.476,3.487,2.476C4.274,13.846,2.7,14.384,0.9,14.384c-0.338,0-0.563,0-0.9,0C1.688,15.354,3.601,16,5.625,16c6.75,0,10.462-5.385,10.462-10.015c0-0.108,0-0.323,0-0.431C16.875,5.016,17.549,4.371,18,3.617z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG TWITTER -->\n\n  <!-- SVG TWITCH -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-twitch\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M6.179,0L0,17.964V87.81h24.714V100h15.789L52.86,87.81h18.993L100,60.527V0H6.179z M90.39,57.645L74.828,72.504H49.885L37.299,84.703V72.504H15.561V9.094H90.39V57.645z M49.885,27.051h-9.382v27.27h9.382V27.051z M74.828,27.051h-9.382v27.27h9.382V27.051z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG TWITCH -->\n\n  <!-- SVG YOUTUBE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-youtube\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M97.911,24.557c-1.149-4.549-4.538-8.13-8.842-9.347C81.271,13,49.999,13,49.999,13s-31.271,0-39.07,2.21c-4.302,1.216-7.69,4.798-8.84,9.347C0,32.8,0,50.001,0,50.001s0,17.2,2.089,25.443c1.15,4.549,4.538,8.132,8.84,9.348C18.729,87,49.999,87,49.999,87s31.271,0,39.07-2.208c4.304-1.216,7.692-4.799,8.842-9.348C100,67.201,100,50.001,100,50.001S100,32.8,97.911,24.557z M39.999,65.858V34.144L65.98,50.001L39.999,65.858z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG YOUTUBE -->\n\n  <!-- SVG INSTAGRAM -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-instagram\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M72.402,0H27.595C12.379,0,0,12.381,0,27.597v44.809C0,87.619,12.379,100,27.595,100h44.807C87.621,100,100,87.619,100,72.406V27.597C100,12.381,87.621,0,72.402,0z M88.691,71.078c0,9.711-7.902,17.613-17.615,17.613H28.923c-9.712,0-17.613-7.902-17.613-17.613V28.926c0-9.715,7.901-17.618,17.613-17.618h42.153c9.713,0,17.615,7.903,17.615,17.618V71.078z M50.001,26.779c-12.804,0-23.22,10.426-23.22,23.22c0,12.804,10.416,23.22,23.22,23.22c12.801,0,23.217-10.416,23.217-23.22C73.219,37.205,62.803,26.779,50.001,26.779z M50.001,63.689c-7.548,0-13.688-6.139-13.688-13.691c0-7.545,6.14-13.684,13.688-13.684c7.545,0,13.686,6.139,13.686,13.684C63.688,57.551,57.547,63.689,50.001,63.689z M75.658,17.864c-1.711,0-4.383,0.724-5.711,2.056c-1.332,1.328-2.098,3.178-2.098,5.065c0,1.882,0.766,3.727,2.098,5.063c1.326,1.325,3.172,2.098,5.051,2.098c1.885,0,3.723-0.772,5.055-2.098c1.332-1.336,2.094-3.184,2.094-5.063c0-1.888-0.762-3.737-2.094-5.065C78.729,18.587,77.373,17.864,75.658,17.864z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG INSTAGRAM -->\n\n  <!-- SVG DISCORD -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-discord\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M87.671,23.75C75.993,15.223,64.855,15,63.707,15c-0.061,0-0.093,0-0.093,0l-1.2,1.332c14.556,4.332,21.32,10.582,21.32,10.582c-8.906-4.749-17.639-7.083-25.771-8c-2.7-0.291-5.353-0.422-7.926-0.422c-3.287,0-6.437,0.216-9.371,0.591c-0.512,0-0.941,0.084-1.456,0.165c-2.994,0.252-10.273,1.334-19.434,5.249c-3.167,1.417-5.052,2.417-5.052,2.417s7.107-6.583,22.518-10.915L36.387,15c0,0-0.032,0-0.098,0c-1.144,0-12.283,0.223-23.96,8.75C12.329,23.75,0,45.498,0,72.333c0,0,7.19,12.081,26.114,12.667c0,0,3.166-3.752,5.734-6.919c-10.873-3.168-14.981-9.831-14.981-9.831s0.854,0.582,2.397,1.414l0.343,0.25l0.769,0.419c2.14,1.163,4.282,2.084,6.251,2.833c3.511,1.334,7.706,2.663,12.584,3.585c3.51,0.633,7.349,1.047,11.451,1.047c3.408,0,6.999-0.284,10.728-0.964c4.021-0.67,8.129-1.836,12.415-3.585c2.991-1.083,6.333-2.665,9.845-4.916c0,0-4.287,6.831-15.5,9.915C70.717,81.414,73.805,85,73.805,85C92.722,84.414,100,72.333,100,72.333C100,45.498,87.671,23.75,87.671,23.75z M34.869,66.745c-5.046,0-9.136-4.056-9.136-9.059c0-5.002,4.09-9.059,9.136-9.059c5.045,0,9.137,4.057,9.137,9.059C44.006,62.689,39.914,66.745,34.869,66.745z M67.758,66.745c-5.045,0-9.135-4.056-9.135-9.059c0-5.002,4.09-9.059,9.135-9.059c5.046,0,9.137,4.057,9.137,9.059C76.895,62.689,72.804,66.745,67.758,66.745z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG DISCORD -->\n\n  <!-- SVG PATREON -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-patreon\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M0,100h16.667V0H0V100z M62.5,0C41.79,0,25,16.788,25,37.5c0,20.71,16.789,37.503,37.5,37.503c20.711,0,37.5-16.793,37.5-37.503C100,16.788,83.211,0,62.5,0z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG PATREON -->\n\n  <!-- SVG GOOGLE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-google\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M100,47.82H89.963v9.785H79.927V47.82H69.89v-9.784h10.037v-9.784h10.036v9.784H100V47.82z M32.358,83C14.487,83,0,68.226,0,50c0-18.226,14.487-33,32.358-33c8.594,0,16.384,3.437,22.173,9.013l-0.6,0.612L45,35.734c-3.349-3.087-7.773-4.984-12.642-4.984c-10.426,0-18.877,8.619-18.877,19.25c0,10.632,8.451,19.25,18.877,19.25c8.046,0,14.898-5.143,17.614-12.375l-15.21,0.729V42.927l28.606,0.199v1.375v12.375v2.516C59.4,73.038,47.028,83,32.358,83z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG GOOGLE -->\n\n  <!-- SVG BEHANCE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-behance\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M99.827,61.223H68.064c0,3.648,0.755,10.949,10.776,10.949s9.643-6.916,9.643-6.916H99.26c0,18.249-20.986,16.713-20.986,16.713c-24.012,0-23.822-20.746-23.822-20.746\n    c0-5.668-0.095-27.087,24.39-27.087S99.827,61.223,99.827,61.223z M78.273,43.356c-9.714,0-10.209,9.221-10.209,9.221h19.852C87.916,52.577,87.987,43.356,78.273,43.356z M64.661,21.458h26.091v8.067H64.661V21.458z M35.166,80.799v0.016H0V18h34.032c0,0,0.024,0,0.062,0h1.072v0.054c3.628,0.299,14.748,2.292,14.748,15.506c0,0,1.144,10.259-7.661,12.951\n    c4.671,0.871,9.93,4.394,9.93,15.863C52.183,62.373,53.762,80.43,35.166,80.799z M33.465,29.525H14.748V42.78h18.15c0,0,3.97-1.057,3.97-6.915C36.868,30.006,33.465,29.525,33.465,29.525z M34.032,53.154H14.748V69.29h18.717c0,0,5.672-1.249,5.672-8.067C39.137,54.402,34.032,53.154,34.032,53.154z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG BEHANCE -->\n\n  <!-- SVG DEVIANTART -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-deviantart\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M83,80.77H48.107L37.204,100H17V82.052l21.362-37.18H17V20.513h35.356L64.143,0H83v19.231L61.918,56.41H83V80.77z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG DEVIANTART -->\n\n  <!-- SVG ARTSTATION -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-artstation\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M0,77.114l8.412,16.545c1.7,3.754,5.102,6.341,8.981,6.341h56.038l-11.62-22.886H0z M98.391,71.002L65.502,6.122C63.797,2.47,60.491,0,56.617,0H39.224l50.755,99.889l8.035-15.79c1.515-3.001,1.986-4.29,1.986-6.877C100,74.967,99.432,72.819,98.391,71.002z M31,16.217L8.315,60.799h45.276L31,16.217z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG ARTSTATION -->\n\n  <!-- SVG CROSS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-cross\" viewBox=\"0 0 12 12\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M12,9.6L9.6,12L6,8.399L2.4,12L0,9.6L3.6,6L0,2.4L2.4,0L6,3.6L9.6,0L12,2.4L8.399,6L12,9.6z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG CROSS -->\n\n  <!-- SVG GRID -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-grid\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M7,0H2C0.896,0,0,0.895,0,2v5c0,1.104,0.896,2,2,2h5c1.104,0,2-0.896,2-2V2C9,0.895,8.104,0,7,0z M7,7H2V2h5V7z M7,11H2c-1.104,0-2,0.896-2,1.999v5C0,19.104,0.896,20,2,20h5c1.104,0,2-0.896,2-2.001v-5C9,11.896,8.104,11,7,11z M7,17.999H2v-5h5V17.999z M18,0h-5c-1.104,0-2,0.895-2,2v5c0,1.104,0.896,2,2,2h5c1.104,0,2-0.896,2-2V2C20,0.895,19.104,0,18,0z M18,7h-5V2h5V7z M18,11h-5c-1.104,0-2,0.896-2,1.999v5C11,19.104,11.896,20,13,20h5c1.104,0,2-0.896,2-2.001v-5C20,11.896,19.104,11,18,11z M18,17.999h-5v-5h5V17.999z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG GRID -->\n\n  <!-- SVG DOTS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-dots\" viewBox=\"0 0 10 2\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M0,2h2V0H0V2z M4,2h2V0H4V2z M8,0v2h2V0H8z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG DOTS -->\n\n  <!-- SVG MAGNIFYING GLASS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-magnifying-glass\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M8,2c3.309,0,6,2.691,6,6s-2.691,6-6,6s-6-2.691-6-6S4.691,2,8,2 M8,0C3.582,0,0,3.582,0,8c0,4.418,3.582,8,8,8c4.418,0,8-3.582,8-8C16,3.582,12.418,0,8,0L8,0z\"/>\n      <path d=\"M19.171,15.168l-3.134-3.134c-0.309,0.613-0.679,1.19-1.113,1.714l2.833,2.834c0.323,0.324,0.323,0.851,0,1.175C17.545,17.969,17.298,18,17.17,18c-0.129,0-0.376-0.031-0.588-0.243l-2.834-2.833c-0.523,0.435-1.101,0.805-1.714,1.113l3.134,3.134C15.721,19.724,16.445,20,17.169,20c0.725,0,1.449-0.276,2.002-0.829C20.276,18.065,20.276,16.273,19.171,15.168z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG MAGNIFYING GLASS -->\n\n  <!-- SVG COMMENT -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-comment\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M15,2c1.654,0,3,1.257,3,2.803v6.404c0,1.546-1.346,2.803-3,2.803H7.98H7.508l-0.422,0.211L2,16.764v-5.557V10V4.803C2,3.257,3.346,2,5,2H15 M15,0H5C2.238,0,0,2.15,0,4.803V10v1.207V20l7.98-3.99H15c2.762,0,5-2.15,5-4.803V4.803C20,2.15,17.762,0,15,0L15,0z\"/>\n      <g>\n        <path d=\"M14,5H6C5.447,5,5,5.448,5,6c0,0.553,0.447,1,1,1h8c0.553,0,1-0.447,1-1C15,5.448,14.553,5,14,5z M10,9H6c-0.553,0-1,0.447-1,1s0.447,1,1,1h4c0.553,0,1-0.447,1-1S10.553,9,10,9z\"/>\n      </g>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG COMMENT -->\n\n  <!-- SVG THUMBS UP -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-thumbs-up\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M15.896,19.999c-0.01,0-0.021,0-0.03,0H2.826C1.268,19.999,0,18.743,0,17.201v-6.302c0-1.543,1.269-2.797,2.826-2.797h2.096l3.391-7.515C8.473,0.229,8.83,0,9.223,0c2.063,0,3.742,1.659,3.742,3.698l0.026,2.3h4.996c0.152-0.003-0.149-0.023,0,0c0.753,0.111,1.962,0.245,1.999,1c0.037,0.757-0.011,2.143,0,3.003l-1.295,7.624C18.483,18.982,17.284,19.999,15.896,19.999z M6.995,18.005h8.881c0.003,0,0.007,0,0.01,0c0.418,0,0.77-0.292,0.83-0.684l1.262-8.106c0.031-0.205-0.02-0.412-0.145-0.583c-0.132-0.178-0.621-0.601-0.845-0.634c-0.045-0.008,0.045-0.006,0,0h-4.996c-0.553,0-1-1.451-1-2.001l-0.026-2.3c0-0.733-0.477-1.36-1.144-1.6l-2.828,6.9V18.005z M2.997,10c-0.456,0-0.999,0.457-0.999,0.899v6.302c0,0.442,0.371,0.804,0.827,0.804h2.17V10H2.997z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG THUMBS UP -->\n\n  <!-- SVG FRIEND -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-friend\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,0C4.477,0,0,4.478,0,10c0,5.523,4.477,10,10,10c5.522,0,10-4.477,10-10C20,4.478,15.522,0,10,0z M10,18c-4.418,0-8-3.582-8-8c0-4.418,3.582-8,8-8s8,3.582,8,8\n        C18,14.418,14.418,18,10,18z M10,13c-1.305,0-2.403-0.838-2.816-2H5.101c0.464,2.282,2.48,4,4.899,4s4.436-1.718,4.899-4h-2.083C12.403,12.162,11.305,13,10,13z M7,7H5v2h2V7z M13,9h2V7h-2V9z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG FRIEND -->\n\n  <!-- SVG GROUP -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-group\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,2c1.654,0,3,1.346,3,3s-1.346,3-3,3S7,6.654,7,5S8.346,2,10,2 M10,0C7.238,0,5,2.238,5,5s2.238,5,5,5s5-2.238,5-5S12.762,0,10,0L10,0z\"/>\n      <path d=\"M3,20v-2c0-2.205,1.794-4,4-4h6c2.206,0,4,1.795,4,4v2h2v-2c0-3.313-2.687-6-6-6H7c-3.313,0-6,2.687-6,6v2H3z\"/>\n      <path d=\"M20,8.05c-1.13,0-2.05-0.919-2.05-2.05S18.87,3.95,20,3.95v-2c-2.236,0-4.05,1.813-4.05,4.05s1.813,4.05,4.05,4.05V8.05z\"/>\n      <path d=\"M0,8.05C1,8.05,2.05,7.13,2.05,6S1,3.95,0,3.95v-2c2,0,4.05,1.813,4.05,4.05S2,10.05,0,10.05V8.05z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG GROUP -->\n\n  <!-- SVG MARKETPLACE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-marketplace\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M18,6h-0.5L16,0h-4v2h2.438l1,4H4.562l1-4H8V0H4L2.5,6H2C0.896,6,0,6.896,0,8v2c0,0.738,0.405,1.376,1,1.723v0.276C1,12,1,12,1,12l1,6c0,1.104,0.896,2,2,2h12c1.104,0,2-0.896,2-2l1-6v-0.277c0.596-0.347,1-0.984,1-1.723V8C20,6.896,19.104,6,18,6z M2,8h16v2h-0.999H17H3H2.999H2V8z M16.027,17.671L16,17.834V18H4v-0.165l-0.027-0.164L3.028,12h13.945L16.027,17.671z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG MARKETPLACE -->\n\n  <!-- SVG ADD FRIEND -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-add-friend\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,13c-1.305,0-2.403-0.838-2.816-2H5.101c0.464,2.282,2.48,4,4.899,4s4.436-1.718,4.899-4h-2.083C12.403,12.162,11.305,13,10,13z M7,7H5v2h2V7z M13,7v2h2V7H13z\"/>\n      <polygon points=\"20,2 18,2 18,0 16,0 16,2 14,2 14,4 16,4 16,6 18,6 18,4 20,4\"/>\n      <path d=\"M17.738,8C17.903,8.64,18,9.308,18,10c0,4.418-3.582,8-8,8s-8-3.582-8-8c0-4.418,3.582-8,8-8c0.692,0,1.359,0.097,2,0.262V0.201C11.354,0.07,10.685,0,10,0C4.477,0,0,4.478,0,10\n      c0,5.523,4.477,10,10,10c5.522,0,10-4.477,10-10c0-0.685-0.069-1.354-0.201-2H17.738z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG ADD FRIEND -->\n\n  <!-- SVG REMOVE FRIEND -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-remove-friend\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,13c-1.305,0-2.403-0.838-2.816-2H5.101c0.464,2.282,2.48,4,4.899,4s4.436-1.718,4.899-4h-2.083C12.403,12.162,11.305,13,10,13z M7,7H5v2h2V7z M13,7v2h2V7H13z\"/>\n      <path d=\"M17.738,8C17.903,8.64,18,9.308,18,10c0,4.418-3.582,8-8,8s-8-3.582-8-8c0-4.418,3.582-8,8-8c0.692,0,1.359,0.097,2,0.262V0.201C11.354,0.07,10.685,0,10,0C4.477,0,0,4.478,0,10\n      c0,5.523,4.477,10,10,10c5.522,0,10-4.477,10-10c0-0.685-0.069-1.354-0.201-2H17.738z\"/>\n      <rect x=\"14\" y=\"2\" width=\"6\" height=\"2\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG REMOVE FRIEND -->\n\n  <!-- SVG DELETE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-delete\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,20C4.477,20,0,15.523,0,10C0,4.478,4.477,0,10,0C15.522,0,20,4.478,20,10C20,15.523,15.522,20,10,20z M10,2c-4.418,0-8,3.582-8,8c0,4.418,3.582,8,8,8s8-3.582,8-8\n      C18,5.582,14.418,2,10,2z M12.662,13.994L10,11.332l-2.662,2.662l-1.331-1.33l2.662-2.663L6.007,7.339l1.331-1.331L10,8.67l2.662-2.662l1.331,1.331l-2.662,2.662l2.662,2.663L12.662,13.994z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG DELETE -->\n\n  <!-- SVG MESSAGES -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-messages\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M12,2c1.103,0,2,0.897,2,2v5c0,1.103-0.897,2-2,2H8H7.754l-0.239,0.06L2,12.438V9V4c0-1.103,0.897-2,2-2H12M12,0H4C1.791,0,0,1.791,0,4v5v6l8-2h4c2.209,0,4-1.791,4-4V4C16,1.791,14.209,0,12,0L12,0z\"/>\n      <path d=\"M12,5.012C12,5.558,11.558,6,11.013,6H4.987C4.442,6,4,5.558,4,5.012V4.988C4,4.442,4.442,4,4.987,4h6.025C11.558,4,12,4.442,12,4.988V5.012z\"/>\n      <path d=\"M10,8.047C10,8.574,9.573,9,9.047,9H4.953C4.427,9,4,8.574,4,8.047V7.953C4,7.426,4.427,7,4.953,7h4.094C9.573,7,10,7.426,10,7.953V8.047z\"/>\n      <path d=\"M17,5.142v2.136C17.595,7.625,18,8.263,18,9v5v3.438l-5.516-1.379L12.246,16H12H8c-0.737,0-1.375-0.405-1.722-1H4.142C4.588,16.722,6.139,18,8,18h4l8,2v-6V9C20,7.139,18.722,5.588,17,5.142z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG MESSAGES -->\n\n  <!-- SVG SEND MESSAGE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-send-message\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M19.993,0.94c-0.005-0.091-0.022-0.179-0.052-0.265c-0.011-0.031-0.021-0.062-0.035-0.093  c-0.049-0.107-0.109-0.208-0.195-0.294s-0.188-0.147-0.294-0.195c-0.031-0.014-0.062-0.024-0.093-0.035c-0.086-0.03-0.173-0.046-0.263-0.052C19.034,0.005,19.009,0,18.981,0c-0.104,0.002-0.207,0.017-0.308,0.052L0.67,6.353C0.283,6.488,0.018,6.846,0.001,7.256C-0.016,7.666,0.22,8.044,0.594,8.21l7.75,3.446l3.444,7.75C11.948,19.769,12.308,20,12.702,20\n      c0.014,0,0.027,0,0.041-0.002c0.409-0.016,0.768-0.28,0.903-0.668l6.302-18.003c0.035-0.101,0.05-0.206,0.052-0.309C20,0.991,19.994,0.967,19.993,0.94z M15.197,3.388L8.88,9.706L3.711,7.408L15.197,3.388z M12.592,16.288l-2.298-5.169l6.317-6.316L12.592,16.288z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG SEND MESSAGE -->\n\n  <!-- SVG BACK ARROW -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-back-arrow\" viewBox=\"0 0 14 10\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M14,6H3.364l2.644,2.75L4.806,10L1.202,6.25l0,0L0,5L4.806,0l1.201,1.25L3.364,4H14V6z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG BACK ARROW -->\n\n  <!-- SVG SHOPPING BAG -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-shopping-bag\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M15.904,6c0.148,0.117,0.347,0.386,0.406,0.557l0.001,0.017l0.676,11.421c-0.005,0.003-0.01,0.005-0.013,0.006H3.029c-0.004-0.001-0.01-0.003-0.016-0.006L3.689,6.573L3.69,6.556C3.749,6.386,3.947,6.117,4.095,6H15.904 M16.075,4H3.924C2.806,4,1.692,5.563,1.692,6.455L1,18.154C1,19.048,1.906,20,3.024,20h13.95C18.093,20,19,19.048,19,18.154L18.308,6.455C18.308,5.563,17.193,4,16.075,4L16.075,4z\"/>\n      <path d=\"M8,8V3.893C8,2.849,8.849,2,9.893,2H10h0.054C11.098,2,12,2.849,12,3.893V8h2V3.893C14,1.743,12.257,0,10.107,0H9.893C7.743,0,6,1.743,6,3.893V8H8z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG SHOPPING BAG -->\n\n  <!-- SVG NOTIFICATION -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-notification\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M18.583,14.127c-0.023-0.018-2.241-1.758-2.241-7.52C16.342,2.964,13.497,0,10.004,0C6.511,0,3.668,2.964,3.668,6.607c0,5.762-2.22,7.502-2.228,7.508c-0.365,0.254-0.525,0.725-0.397,1.158c0.129,0.434,0.517,0.73,0.957,0.73h16.007c0.433,0,0.81-0.293,0.943-0.719C19.086,14.861,18.932,14.389,18.583,14.127zM4.086,13.939C4.873,12.527,5.67,10.21,5.67,6.607c0-2.505,1.945-4.542,4.334-4.542c2.391,0,4.335,2.038,4.335,4.542c0,3.603,0.796,5.92,1.583,7.333H4.086z M12.418,17.146c-0.57-0.283-1.293-0.115-1.619,0.381c-0.126,0.191-0.327,0.326-0.567,0.383c-0.234,0.051-0.478,0.023-0.688-0.084c-0.138-0.07-0.255-0.174-0.336-0.297c-0.325-0.496-1.05-0.668-1.618-0.385c-0.568,0.283-0.766,0.914-0.44,1.408c0.286,0.438,0.7,0.803,1.194,1.055C8.854,19.867,9.421,20,9.997,20c0.281,0,0.564-0.031,0.843-0.096c0.856-0.197,1.573-0.676,2.016-1.348C13.182,18.061,12.984,17.432,12.418,17.146z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG NOTIFICATION -->\n\n  <!-- SVG SETTINGS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-settings\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,7c-1.657,0-3,1.343-3,3c0,1.655,1.343,2.999,3,2.999c1.656,0,3-1.344,3-2.999C13,8.343,11.656,7,10,7zM10,11c-0.552,0-1-0.449-1-1c0-0.552,0.448-1,1-1s1,0.448,1,1C11,10.551,10.552,11,10,11z M17.363,12.638C18.817,12.638,20,11.453,20,10s-1.183-2.637-2.637-2.637h-0.135c-0.106,0-0.205-0.049-0.27-0.129 c-0.014-0.054-0.032-0.106-0.055-0.158c-0.059-0.132-0.031-0.283,0.111-0.429c0.498-0.499,0.772-1.161,0.772-1.865c0-0.704-0.274-1.367-0.773-1.865c-0.997-0.997-2.693-1.035-3.769,0.042c-0.102,0.1-0.24,0.135-0.397,0.066c-0.129-0.055-0.212-0.18-0.212-0.391C12.637,1.182,11.454,0,10,0S7.363,1.182,7.363,2.636v0.135c0,0.106-0.049,0.206-0.129,0.271C7.181,3.056,7.128,3.073,7.077,3.096c-0.128,0.058-0.264,0.052-0.43-0.113c-0.996-0.994-2.731-0.995-3.73,0.003c-1.026,1.028-1.025,2.701,0.044,3.77C3.062,6.858,3.089,7.01,3.007,7.2c-0.05,0.136-0.176,0.227-0.371,0.229C1.183,7.429,0,8.612,0,10.065c0,1.454,1.183,2.637,2.636,2.637h0.138c0.138,0,0.263,0.083,0.322,0.222c0.058,0.132,0.03,0.284-0.113,0.429c-0.497,0.498-0.771,1.161-0.771,1.865c0.001,0.705,0.276,1.367,0.773,1.863c0.996,0.996,2.689,1.038,3.771-0.042c0.101-0.099,0.142-0.173,0.443-0.046c0.136,0.049,0.226,0.176,0.229,0.37\n      c0,1.454,1.183,2.637,2.637,2.637s2.637-1.183,2.637-2.637v-0.137c0-0.139,0.083-0.263,0.222-0.322c0.129-0.058,0.263-0.051,0.428,0.112c0.999,0.995,2.735,0.996,3.73-0.002c0.498-0.499,0.771-1.162,0.771-1.866c-0.001-0.704-0.275-1.366-0.813-1.903c-0.101-0.104-0.129-0.256-0.064-0.398C17.029,12.72,17.154,12.638,17.363,12.638zM15.666,14.7c0.121,0.12,0.188,0.279,0.188,0.449s-0.067,0.33-0.188,0.453c-0.239,0.241-0.605,0.295-0.956-0.058c-0.677-0.662-1.742-0.845-2.582-0.475c-0.864,0.369-1.423,1.214-1.425,2.153v0.14c0,0.352-0.286,0.636-0.637,0.636s-0.637-0.284-0.637-0.733c-0.023-0.97-0.627-1.815-1.479-2.125C7.649,15.007,7.329,14.939,7,14.939c-0.618,0-1.202,0.238-1.7,0.728c-0.24,0.24-0.66,0.241-0.901-0.002c-0.248-0.246-0.248-0.65,0.058-0.957c0.675-0.69,0.859-1.709,0.474-2.58c-0.368-0.864-1.214-1.424-2.154-1.426h-0.14C2.285,10.702,2,10.416,2,10.065\n      s0.285-0.637,0.733-0.637c0.971-0.023,1.815-0.626,2.127-1.48c0.39-0.884,0.205-1.9-0.527-2.648C4.085,5.052,4.085,4.647,4.334,4.398c0.24-0.24,0.603-0.298,0.957,0.058C5.92,5.07,6.871,5.282,7.694,5c0.084-0.013,0.167-0.036,0.245-0.07c0.861-0.37,1.42-1.214,1.424-2.155v-0.14C9.363,2.285,9.649,2,10,2s0.637,0.285,0.637,0.712c0.002,0.937,0.561,1.782,1.414,2.148c0.865,0.38,1.884,0.222,2.649-0.527c0.241-0.24,0.656-0.243,0.901,0.001c0.12,0.12,0.187,0.279,0.187,0.449c0,0.169-0.066,0.331-0.242,0.507c-0.629,0.642-0.834,1.566-0.545,2.405\n      c0.013,0.083,0.035,0.165,0.069,0.244c0.369,0.862,1.213,1.421,2.154,1.425h0.139C17.715,9.364,18,9.649,18,10c0,0.351-0.285,0.637-0.712,0.637c-0.938,0.002-1.783,0.561-2.146,1.411C14.749,12.933,14.933,13.951,15.666,14.7z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG SETTINGS -->\n\n  <!-- SVG CROSS THIN -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-cross-thin\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M18,16.547L16.545,18L10,11.455L3.455,18L2,16.547L8.545,10L2,3.455L3.455,2L10,8.546L16.545,2L18,3.455L11.455,10L18,16.547z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG CROSS THIN -->\n\n  <!-- SVG NEWSFEED -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-newsfeed\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,0H4C1.791,0,0,1.791,0,4v8c0,2.209,1.791,4,4,4h12c2.209,0,4-1.791,4-4V4C20,1.791,18.209,0,16,0zM18,12c0,1.103-0.897,2-2,2H4c-1.103,0-2-0.897-2-2V4c0-1.103,0.897-2,2-2h12c1.103,0,2,0.897,2,2V12z\"/>\n      <path d=\"M0,10v2h20v-2H0z M5,20h10v-2H5V20z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG NEWSFEED -->\n\n  <!-- SVG OVERVIEW -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-overview\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M18,8v10h-2V8H18 M18,6h-2c-1.104,0-2,0.896-2,2v10c0,1.104,0.896,2,2,2h2c1.104,0,2-0.896,2-2V8C20,6.896,19.104,6,18,6L18,6z\"/>\n      <path d=\"M11,2v16H9V2H11 M11,0H9C7.896,0,7,0.896,7,2v16c0,1.104,0.896,2,2,2h2c1.104,0,2-0.896,2-2V2C13,0.896,12.104,0,11,0L11,0z\"/>\n      <path d=\"M4,14v4H2v-4H4 M4,12H2c-1.104,0-2,0.896-2,2v4c0,1.104,0.896,2,2,2h2c1.104,0,2-0.896,2-2v-4C6,12.896,5.104,12,4,12L4,12z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG OVERVIEW -->\n\n  <!-- SVG MEMBERS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-members\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,10c2.762,0,5-2.238,5-5c0-2.762-2.238-5-5-5S5,2.238,5,5C5,7.761,7.238,10,10,10z M10,2c1.654,0,3,1.346,3,3s-1.346,3-3,3S7,6.654,7,5S8.346,2,10,2z M13,12H7c-3.313,0-6,2.686-6,6v2h2v-2c0-2.205,1.794-4,4-4h6c2.206,0,4,1.795,4,4v2h2v-2C19,14.686,16.313,12,13,12z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG MEMBERS -->\n\n  <!-- SVG BADGES -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-badges\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,8c2.757,0,5,2.243,5,5s-2.243,5-5,5s-5-2.243-5-5S7.243,8,10,8 M10,6c-3.866,0-7,3.134-7,7s3.134,7,7,7c3.865,0,7-3.134,7-7S13.865,6,10,6L10,6z\"/>\n      <path d=\"M3.906,6.391L2.651,2h3.84l0.701,2.453c0.627-0.206,1.283-0.347,1.963-0.41L8,0H0l2.36,8.26C2.79,7.568,3.31,6.941,3.906,6.391z\"/>\n      <path d=\"M12.808,4.453L13.509,2h3.84l-1.255,4.391C16.689,6.94,17.21,7.568,17.64,8.26L20,0h-8l-1.155,4.043C11.524,4.106,12.181,4.247,12.808,4.453z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG BADGES -->\n\n  <!-- SVG QUESTS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-quests\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,2.708l1.774,3.813l0.452,0.97l1.058,0.163l4.138,0.637l-3.07,3.175l-0.697,0.721l0.16,0.989l0.7,4.326l-3.494-1.947l-0.965-0.538L10,15.048l-0.055-0.03L8.98,15.556l-3.494,1.947l0.7-4.326l0.16-0.989l-0.697-0.721L2.578,8.292l4.138-0.637l1.058-0.163l0.451-0.97L10,2.708 M10.029-0.004C10.019-0.004,10.01-0.002,10,0C9.99-0.002,9.981-0.004,9.971-0.004\n      c-0.558,0-1.066,0.326-1.303,0.834L6.412,5.678L1.223,6.477c-0.534,0.082-0.977,0.46-1.148,0.976c-0.172,0.517-0.042,1.086,0.334,1.474l3.802,3.932l-0.882,5.453c-0.089,0.548,0.141,1.1,0.591,1.42c0.248,0.176,0.539,0.266,0.83,0.266c0.24,0,0.479-0.061,0.697-0.182l4.507-2.512L10,17.328l0.046-0.025l4.506,2.512c0.219,0.121,0.457,0.182,0.697,0.182c0.291,0,0.582-0.09,0.83-0.266c0.45-0.32,0.68-0.872,0.591-1.42l-0.882-5.453l3.802-3.932c0.376-0.387,0.507-0.957,0.335-1.474c-0.172-0.515-0.614-0.894-1.148-0.976l-5.189-0.798l-2.256-4.848C11.095,0.322,10.586-0.004,10.029-0.004L10.029-0.004z\"/>\n      <rect x=\"7\" y=\"9\" width=\"2\" height=\"2\"/>\n      <rect x=\"11\" y=\"9\" width=\"2\" height=\"2\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG QUESTS -->\n\n  <!-- SVG STREAMS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-streams\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,3c1.103,0,2,0.897,2,2v10c0,1.103-0.897,2-2,2H4c-1.103,0-2-0.897-2-2V5c0-1.103,0.897-2,2-2H16 M16,1H4C1.791,1,0,2.791,0,5v10c0,2.209,1.791,4,4,4h12c2.209,0,4-1.791,4-4V5C20,2.791,18.209,1,16,1L16,1z\"/>\n      <path d=\"M8.405,7c0.102,0,0.219,0.037,0.347,0.115l3.908,2.4c0.439,0.267,0.462,0.704,0.021,0.971l-3.928,2.4C8.624,12.964,8.507,13,8.405,13C8.157,13,8,12.782,8,12.408V7.593C8,7.217,8.157,7,8.405,7 M8.405,5C7.034,5,6,6.115,6,7.593v4.815C6,13.886,7.034,15,8.405,15c0.477,0,0.943-0.137,1.386-0.405l3.932-2.402c0.796-0.481,1.276-1.297,1.277-2.177c0.001-0.888-0.486-1.715-1.304-2.21L9.798,5.411C9.348,5.137,8.881,5,8.405,5L8.405,5z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG STREAMS -->\n\n  <!-- SVG EVENTS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-events\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,2H4C1.791,2,0,3.791,0,6v10c0,2.209,1.791,4,4,4h12c2.209,0,4-1.791,4-4V6C20,3.791,18.209,2,16,2zM18,16c0,1.103-0.897,2-2,2H4c-1.103,0-2-0.897-2-2V6c0-1.103,0.897-2,2-2h12c1.103,0,2,0.897,2,2V16z\"/>\n      <path d=\"M0,8v2h20V8H0z M7,0H5v6h2V0z M15,0h-2v6h2V0z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG EVENTS -->\n\n  <!-- SVG FORUMS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-forums\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,0H4C1.791,0,0,1.592,0,3.556V6v2v4.444C0,14.408,1.791,16,4,16h2l4,4l4-4h2c2.209,0,4-1.592,4-3.556V8V6V3.556C20,1.592,18.209,0,16,0z M18,12.444C18,13.287,17.084,14,16,14h-2h-0.828l-0.586,0.586L10,17.172l-2.586-2.586L6.829,14H6H4c-1.084,0-2-0.713-2-1.556V8h16V12.444z M2,6V3.556C2,2.712,2.916,2,4,2h12c1.084,0,2,0.712,2,1.556V6H2z\"/>\n      <rect x=\"4\" y=\"3\" width=\"2\" height=\"2\"/>\n      <rect x=\"10\" y=\"3\" width=\"2\" height=\"2\"/>\n      <rect x=\"7\" y=\"3\" width=\"2\" height=\"2\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG FORUMS -->\n\n  <!-- SVG SMALL ARROW -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-small-arrow\" viewBox=\"0 0 6 8\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M6,4L1.5,8L0,6.665L3,4L0,1.333L1.5,0l3,2.666l0,0L6,4z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG SMALL ARROW -->\n\n  <!-- SVG BIG ARROW -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-big-arrow\" viewBox=\"0 0 8 12\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M6.399,7.5L6.399,7.5L1.6,12L0,10.5L4.8,6L0,1.5L1.6,0L8,6L6.399,7.5z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG BIG ARROW -->\n\n  <!-- SVG PUBLIC -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-public\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M20,10c0-5.522-4.478-10-10-10C4.477,0,0,4.478,0,10c0,5.523,4.477,10,10,10\n      c1.566,0,3.043-0.37,4.362-1.013l0.01,0.018c0.051-0.028,0.086-0.059,0.135-0.087C17.763,17.27,20,13.9,20,10z M16.155,15.108c-0.648-1.745-2.802-3.14-4.653-3.408c-0.751-0.109-0.829-0.433-0.858-0.555C10.497,10.532,11,9.499,11.679,9.021c1.482-1.044,4.529-0.504,6.252-0.025C17.972,9.325,18,9.659,18,10C18,11.942,17.307,13.723,16.155,15.108z M14.715,3.547c-0.012,0-0.022,0.003-0.034,0.003c-1.374,0-2.609-0.561-3.518-1.456C12.479,2.286,13.688,2.796,14.715,3.547z M2,10\n      c0-2.277,0.956-4.328,2.483-5.785c1.26,0.272,2.644,0.845,2.87,1.36C7.373,5.62,7.425,5.74,7.222,6.051c-0.295,0.451-0.603,0.88-0.896,1.29c-1.389,1.937-2.963,4.131-0.647,6.169c0.537,0.472,0.805,1.243,0.624,1.793c-0.184,0.557-0.815,0.773-1.402,0.86C3.128,14.695,2,12.479,2,10z M7.065,17.437c0.671-0.479,0.993-1.077,1.135-1.507c0.432-1.308-0.063-2.92-1.201-3.922c-0.814-0.716-0.672-1.24,0.951-3.502c0.31-0.432,0.633-0.883,0.944-1.359c0.66-1.009,0.521-1.85,0.289-2.377c-0.428-0.972-1.522-1.606-2.57-2.01C7.251,2.46,7.934,2.244,8.65,2.122c1.236,2.047,3.469,3.428,6.03,3.428c0.618,0,1.206-0.106,1.776-0.259c0.339,0.463,0.631,0.961,0.865,1.492c-1.979-0.428-4.906-0.729-6.795,0.603c-1.195,0.84-2.204,2.651-1.828,4.224c0.268,1.122,1.185,1.876,2.516,2.068c1.409,0.205,2.963,1.352,3.137,2.314c0.028,0.156,0.1,0.618-0.781,1.158C12.495,17.689,11.285,18,10,18C8.963,18,7.975,17.796,7.065,17.437z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG PUBLIC -->\n\n  <!-- SVG PRIVATE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-private\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M11,11H9c-0.553,0-1,0.447-1,1s0.447,1,1,1v1c0,0.553,0.447,1,1,1s1-0.447,1-1v-1c0.553,0,1-0.447,1-1S11.553,11,11,11z\"/>\n      <path d=\"M16,6.142V6c0-3.313-2.687-6-6-6S4,2.687,4,6v0.142C2.278,6.588,1,8.139,1,10v6c0,2.209,1.791,4,4,4h10c2.209,0,4-1.791,4-4v-6C19,8.139,17.722,6.588,16,6.142z M10,2c2.206,0,4,1.794,4,4H6C6,3.794,7.794,2,10,2z M17,16c0,1.103-0.897,2-2,2H5c-1.103,0-2-0.897-2-2v-6c0-1.103,0.897-2,2-2h10c1.103,0,2,0.897,2,2V16z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG PRIVATE -->\n\n  <!-- SVG JOIN GROUP -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-join-group\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,9.999c2.762,0,5-2.238,5-5s-2.238-5-5-5s-5,2.238-5,5S7.238,9.999,10,9.999z M10,1.999c1.654,0,3,1.346,3,3s-1.346,3-3,3s-3-1.346-3-3S8.346,1.999,10,1.999z M20,3.949v-2c-2.236,0-4.05,1.813-4.05,4.05c0,2.236,1.813,4.05,4.05,4.05v-2c-1.13,0-2.05-0.92-2.05-2.05C17.95,4.869,18.87,3.949,20,3.949z M4.05,5.999C4.05,3.762,2,1.949,0,1.949v2c1,0,2.05,0.919,2.05,2.05c0,1.13-1.05,2.05-2.05,2.05v2C2,10.049,4.05,8.235,4.05,5.999zM11,13.999H9v2H7v2h2v2h2v-2h2v-2h-2V13.999z M7,11.999c-3.313,0-6,2.687-6,6v2h2v-2c0-2.205,1.794-4,4-4V11.999z M13,11.999v2c2.206,0,4,1.795,4,4v2h2v-2C19,14.686,16.313,11.999,13,11.999z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG JOIN GROUP -->\n\n  <!-- SVG LEAVE GROUP -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-leave-group\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,9.999c2.762,0,5-2.238,5-5s-2.238-5-5-5s-5,2.238-5,5S7.238,9.999,10,9.999z M10,1.999c1.654,0,3,1.346,3,3s-1.346,3-3,3s-3-1.346-3-3S8.346,1.999,10,1.999z M20,3.949v-2c-2.236,0-4.05,1.813-4.05,4.05c0,2.236,1.813,4.05,4.05,4.05v-2c-1.13,0-2.05-0.92-2.05-2.05C17.95,4.869,18.87,3.949,20,3.949z M4.05,5.999C4.05,3.762,2,1.949,0,1.949v2c1,0,2.05,0.919,2.05,2.05c0,1.13-1.05,2.05-2.05,2.05v2C2,10.049,4.05,8.235,4.05,5.999z M7,17.999h6v-2H7V17.999z M7,11.999c-3.313,0-6,2.687-6,6v2h2v-2c0-2.205,1.794-4,4-4V11.999z M13,11.999v2c2.206,0,4,1.795,4,4v2h2v-2C19,14.686,16.313,11.999,13,11.999z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG LEAVE GROUP -->\n\n  <!-- SVG MORE DOTS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-more-dots\" viewBox=\"0 0 22 6\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M19,6c-1.657,0-3-1.344-3-3c0-1.656,1.343-3,3-3s3,1.344,3,3C22,4.656,20.657,6,19,6z M19,2c-0.553,0-1,0.447-1,1c0,0.552,0.447,1,1,1c0.552,0,1-0.449,1-1C20,2.447,19.552,2,19,2z M11,6C9.343,6,8,4.656,8,3c0-1.656,1.343-3,3-3s3,1.344,3,3C14,4.656,12.657,6,11,6z M11,2c-0.553,0-1,0.447-1,1c0,0.552,0.447,1,1,1c0.552,0,1-0.449,1-1C12,2.447,11.552,2,11,2z M3,6C1.343,6,0,4.656,0,3c0-1.656,1.343-3,3-3c1.656,0,3,1.344,3,3C6,4.656,4.656,6,3,6z M3,2C2.447,2,2,2.447,2,3c0,0.552,0.447,1,1,1c0.552,0,1-0.449,1-1C4,2.447,3.552,2,3,2z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG MORE DOTS -->\n\n  <!-- SVG PROFILE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-profile\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,2c4.418,0,8,3.582,8,8c0,4.418-3.582,8-8,8c-4.418,0-8-3.582-8-8C2,5.582,5.582,2,10,2 M10,0C4.486,0,0,4.486,0,10c0,5.514,4.486,10,10,10c5.514,0,10-4.486,10-10C20,4.486,15.514,0,10,0L10,0z\"/>\n      <path d=\"M10,7c0.551,0,1,0.449,1,1s-0.449,1-1,1S9,8.551,9,8S9.449,7,10,7 M10,5C8.343,5,7,6.343,7,8c0,1.656,1.343,3,3,3c1.656,0,3-1.344,3-3C13,6.343,11.656,5,10,5L10,5z\"/>\n      <path d=\"M14.866,15.025C14.43,13.29,12.871,12,11,12H9c-1.871,0-3.43,1.29-3.866,3.025C5.678,15.553,6.308,15.988,7,16.317V16c0-1.104,0.897-2,2-2h2c1.103,0,2,0.896,2,2v0.317C13.692,15.988,14.322,15.553,14.866,15.025z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG PROFILE -->\n\n  <!-- SVG TIMELINE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-timeline\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,0H4C1.791,0,0,1.791,0,4v12c0,2.209,1.791,4,4,4h12c2.209,0,4-1.791,4-4V4C20,1.791,18.209,0,16,0zM18,16c0,1.103-0.897,2-2,2H4c-1.103,0-2-0.897-2-2V4c0-1.103,0.897-2,2-2h12c1.103,0,2,0.897,2,2V16z\"/>\n      <polygon points=\"18,5 2,5 2,7 5,7 5,20 7,20 7,7 13,7 13,20 15,20 15,7 18,7\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG TIMELINE -->\n\n  <!-- SVG PHOTOS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-photos\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,0H4C1.791,0,0,1.791,0,4v12c0,2.209,1.791,4,4,4h12c2.209,0,4-1.791,4-4V4C20,1.791,18.209,0,16,0zM4,2h12c1.103,0,2,0.897,2,2v6.407L16.703,9.11c-0.75-0.751-1.734-1.126-2.718-1.126c-0.984,0-1.968,0.375-2.719,1.126l-2.98,2.98l-0.259-0.259c-0.563-0.563-1.301-0.844-2.039-0.844s-1.476,0.282-2.04,0.844L2,13.782V4C2,2.897,2.897,2,4,2z M16,18H4c-0.918,0-1.686-0.625-1.919-1.47l3.282-3.283c0.226-0.226,0.489-0.259,0.626-0.259c0.137,0,0.399,0.033,0.625,0.258l0.259,0.259l1.414,1.414L9.7,13.505l2.981-2.981c0.348-0.348,0.811-0.54,1.304-0.54c0.492,0,0.955,0.192,1.304,0.541L18,13.234V16C18,17.103,17.103,18,16,18z\"/>\n      <path d=\"M6,9c1.657,0,3-1.344,3-3c0-1.657-1.343-3-3-3S3,4.343,3,6C3,7.656,4.343,9,6,9z M6,5c0.551,0,1,0.449,1,1c0,0.552-0.449,1-1,1S5,6.552,5,6C5,5.449,5.449,5,6,5z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG PHOTOS -->\n\n  <!-- SVG VIDEOS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-videos\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,0H4C1.791,0,0,1.791,0,4v12c0,2.209,1.791,4,4,4h12c2.209,0,4-1.791,4-4V4C20,1.791,18.209,0,16,0zM18,4v1h-2V2C17.103,2,18,2.897,18,4z M4,13H2V7h2V13z M16,7h2v6h-2V7z M14,2v16H6V2H14z M4,2v3H2V4C2,2.897,2.897,2,4,2z M2,16v-1h2v3C2.897,18,2,17.103,2,16z M16,18v-3h2v1C18,17.103,17.103,18,16,18z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG VIDEOS -->\n\n  <!-- SVG BLOG POSTS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-blog-posts\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M15,0H5C2.791,0,1,1.791,1,4v3v2v7c0,2.209,1.791,4,4,4h10c2.209,0,4-1.791,4-4V9V7V4C19,1.791,17.209,0,15,0z M17,16c0,1.103-0.897,2-2,2H5c-1.103,0-2-0.897-2-2V9h14V16z M3,7V4c0-1.103,0.897-2,2-2h10c1.103,0,2,0.897,2,2v3H3z\"/>\n      <rect x=\"5\" y=\"11\" width=\"10\" height=\"2\"/>\n      <rect x=\"13\" y=\"14\" width=\"2\" height=\"2\"/>\n      <rect x=\"5\" y=\"14\" width=\"6\" height=\"2\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG BLOG POSTS -->\n\n  <!-- SVG FORUM -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-forum\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10.969,0H5C2.791,0,1,1.791,1,4v12c0,2.209,1.791,4,4,4h10c2.209,0,4-1.791,4-4V8.125L10.969,0z M11,2.877L16.064,8H13c-1.104,0-2-0.897-2-2V2.877z M15,18H5c-1.103,0-2-0.897-2-2V4c0-1.103,0.897-2,2-2h4v4c0,2.209,1.791,4,4,4h4v6C17,17.103,16.103,18,15,18z\"/>\n      <path d=\"M13,14H7c-0.553,0-1,0.447-1,1s0.447,1,1,1h6c0.552,0,1-0.447,1-1S13.552,14,13,14z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG FORUM -->\n\n  <!-- SVG STORE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-store\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M19.411,4.288l-1.894-3.301C17.174,0.378,16.537,0,15.855,0H4.047C3.37,0,2.734,0.376,2.39,0.981L0.492,4.288C-0.18,5.459-0.227,6.949,0.37,8.177C0.737,8.933,1.314,9.494,2,9.826V16c0,2.209,1.791,4,4,4h8c2.209,0,4-1.791,4-4V9.766c0.642-0.338,1.184-0.871,1.532-1.586C20.13,6.953,20.084,5.462,19.411,4.288z M2.227,5.289L4.047,2h11.732l1.896,3.289c0.343,0.598,0.365,1.388,0.059,2.018c-0.136,0.277-0.452,0.755-1.073,0.845c-0.567,0.088-1.203-0.159-1.624-0.674l-0.772-0.943L13.49,7.477c-0.725,0.883-2.046,0.883-2.767,0.001L9.95,6.532L9.176,7.477C8.452,8.361,7.13,8.359,6.41,7.478L5.636,6.531L4.862,7.478c-0.421,0.515-0.973,0.773-1.639,0.67C2.62,8.06,2.303,7.583,2.168,7.306C1.862,6.675,1.885,5.885,2.227,5.289zM4,10.11c0.582-0.086,1.148-0.295,1.636-0.641c1.263,0.9,3.046,0.9,4.313,0c1.265,0.9,3.046,0.901,4.315,0c0.518,0.368,1.113,0.592,1.736,0.665V14H4V10.11z M14,18H6c-1.103,0-2-0.897-2-2h12C16,17.103,15.103,18,14,18z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG STORE -->\n\n  <!-- SVG STAR -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-star\" viewBox=\"0 0 9 8\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M4.5,0l1.482,2.515L9,3.056L6.899,5.151L7.28,8L4.5,6.78L1.719,8L2.1,5.151L0,3.056l3.017-0.541L4.5,0\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG STAR -->\n\n  <!-- SVG PLAY -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-play\" viewBox=\"0 0 12 14\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M11.182,5.868l-9.378-5.6C0.751-0.355,0,0.147,0,1.383v11.236c0,1.234,0.751,1.737,1.803,1.112l9.431-5.599C12.291,7.51,12.236,6.491,11.182,5.868z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG PLAY -->\n\n  <!-- SVG SHARE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-share\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M15.336,12.6c-0.984,0-1.876,0.399-2.536,1.04l-4.602-2.714c0.077-0.297,0.13-0.604,0.13-0.925s-0.054-0.628-0.13-0.925l4.598-2.717C13.457,7,14.35,7.4,15.336,7.4C17.356,7.4,19,5.741,19,3.7S17.356,0,15.336,0s-3.665,1.66-3.665,3.7c0,0.321,0.054,0.628,0.13,0.925L7.203,7.342C6.543,6.7,5.651,6.3,4.665,6.3C2.644,6.3,1,7.959,1,10c0,2.04,1.645,3.699,3.665,3.699c0.986,0,1.878-0.399,2.538-1.041l4.601,2.713c-0.078,0.299-0.132,0.606-0.132,0.93c0,2.04,1.645,3.699,3.665,3.699S19,18.341,19,16.301C19,14.26,17.356,12.6,15.336,12.6z M15.336,2c0.921,0,1.67,0.763,1.67,1.7s-0.749,1.7-1.67,1.7c-0.922,0-1.672-0.763-1.672-1.7S14.414,2,15.336,2z M4.665,11.699c-0.921,0-1.671-0.763-1.671-1.699c0-0.938,0.75-1.7,1.671-1.7s1.67,0.763,1.67,1.7C6.335,10.937,5.586,11.699,4.665,11.699z M15.336,18c-0.922,0-1.672-0.763-1.672-1.699c0-0.308,0.087-0.592,0.228-0.841c0.003-0.005,0.006-0.008,0.009-0.012c0.003-0.005,0.002-0.01,0.005-0.015c0.292-0.497,0.821-0.834,1.431-0.834c0.921,0,1.67,0.763,1.67,1.701C17.006,17.237,16.257,18,15.336,18z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG SHARE -->\n\n  <!-- SVG PINNED -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-pinned\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M17,20c-0.205,0-0.408-0.063-0.581-0.188L10,15.229l-6.419,4.584c-0.305,0.218-0.706,0.249-1.039,0.077C2.209,19.717,2,19.375,2,19V3c0-1.654,1.346-3,3-3h10c1.654,0,3,1.346,3,3v16c0,0.375-0.209,0.717-0.542,0.89C17.313,19.963,17.156,20,17,20z M10,13c0.203,0,0.407,0.063,0.581,0.186L16,17.057V3c0-0.551-0.448-1-1-1H5C4.448,2,4,2.448,4,3v14.057l5.419-3.871C9.593,13.063,9.796,13,10,13z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG PINNED -->\n\n  <!-- SVG STATUS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-status\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,1H4C1.791,1,0,2.791,0,5v4v2v4c0,2.209,1.791,4,4,4h12c2.209,0,4-1.791,4-4v-4V9V5C20,2.791,18.209,1,16,1z M18,15c0,1.103-0.897,2-2,2H4c-1.103,0-2-0.897-2-2v-4h16V15z M18,9H2V5c0-1.103,0.897-2,2-2h12c1.103,0,2,0.897,2,2V9z\"/>\n      <rect x=\"13\" y=\"13\" width=\"2\" height=\"2\"/>\n      <rect x=\"9\" y=\"13\" width=\"2\" height=\"2\"/>\n      <rect x=\"5\" y=\"5\" width=\"10\" height=\"2\"/>\n      <rect x=\"5\" y=\"13\" width=\"2\" height=\"2\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG STATUS -->\n\n  <!-- SVG BIG GRID VIEW -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-big-grid-view\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,20H4c-2.209,0-4-1.791-4-4V4c0-2.209,1.791-4,4-4h12c2.209,0,4,1.791,4,4v12C20,18.209,18.209,20,16,20z M2,16c0,1.102,0.896,2,2,2h5v-7H2V16z M4,2C2.896,2,2,2.896,2,4v5h7V2H4z M18,4c0-1.104-0.897-2-2-2h-5v7h7V4z M18,11h-7v7h5c1.103,0,2-0.898,2-2V11z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG BIG GRID VIEW -->\n\n  <!-- SVG SMALL GRID VIEW -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-small-grid-view\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,20H4c-2.209,0-4-1.791-4-4V4c0-2.209,1.791-4,4-4h12c2.209,0,4,1.791,4,4v12C20,18.209,18.209,20,16,20z M12,18v-4H8v4H12z M2,16c0,1.102,0.896,2,2,2h2v-4H2V16z M6,2H4C2.896,2,2,2.896,2,4v2h4V2z M2,8v4h4V8H2z M12,2H8v4h4V2z M8,8v4h4V8H8z M18,4c0-1.103-0.897-2-2-2h-2v4h4V4z M18,8h-4v4h4V8zM18,14h-4v4h2c1.103,0,2-0.898,2-2V14z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG SMALL GRID VIEW -->\n\n  <!-- SVG LIST GRID VIEW -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-list-grid-view\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,20H4c-2.209,0-4-1.791-4-4V4c0-2.209,1.791-4,4-4h12c2.209,0,4,1.791,4,4v12C20,18.209,18.209,20,16,20z M2,16c0,1.102,0.896,2,2,2h2v-4H2V16z M6,2H4C2.896,2,2,2.896,2,4v2h4V2z M2,8v4h4V8H2z M18,4c0-1.103-0.897-2-2-2H8v4h10V4z M18,8H8v4h10V8z M18,14H8v4h8c1.103,0,2-0.898,2-2V14z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG LIST GRID VIEW -->\n\n  <!-- SVG PLUS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-plus\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M20,11h-9v9H9v-9H0V9h9V0h2v9h9V11z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG PLUS -->\n\n  <!-- SVG PLUS SMALL -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-plus-small\" viewBox=\"0 0 8 8\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M8,5H5v3H3V5H0V3h3V0h2v3h3V5z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG PLUS SMALL -->\n\n  <!-- SVG MINUS SMALL -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-minus-small\" viewBox=\"0 0 8 8\" preserveAspectRatio=\"xMinYMin meet\">\n      <rect y=\"3\" width=\"8\" height=\"2\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG MINUS SMALL -->\n\n  <!-- SVG POLL -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-poll\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M12,14H2C0.896,14,0,14.896,0,16v2C0,19.104,0.896,20,2,20h10c1.105,0,2-0.896,2-2v-2C14,14.896,13.105,14,12,14z M12,18H2v-2h10V18z M18,7H2C0.896,7,0,7.896,0,9v2C0,12.104,0.896,13,2,13h16c1.104,0,2-0.896,2-2V9C20,7.896,19.104,7,18,7z M18,11H2V9h16V11z M2,6h4C7.105,6,8,5.104,8,4V2C8,0.896,7.105,0,6,0H2C0.896,0,0,0.896,0,2v2C0,5.104,0.896,6,2,6z M2,2h4v2H2V2z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG POLL -->\n\n  <!-- SVG CAMERA -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-camera\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M13.018,2C13.505,2,13.81,2.018,14,2.041v1.964h2c1.103,0,2,0.896,2,1.999v9.998C18,17.104,17.103,18,16,18H4c-1.103,0-2-0.896-2-1.999V6.003c0-1.102,0.897-1.999,2-1.999h2V2.041C6.19,2.018,6.496,2,6.983,2l0.473,0.002L8,2.005h4l0.544-0.003L13.018,2 M13.018,0C12.692,0,12.352,0.005,12,0.005H8C7.648,0.005,7.308,0,6.983,0C5.267,0,4,0.148,4,2.005c-2.209,0-4,1.791-4,3.999v9.998C0,18.21,1.791,20,4,20h12c2.209,0,4-1.79,4-3.999V6.003c0-2.208-1.791-3.999-4-3.999C16,0.148,14.733,0,13.018,0L13.018,0z\"/>\n      <path d=\"M10,10c1.103,0,2,0.896,2,2c0,1.103-0.897,2-2,2c-1.103,0-2-0.897-2-2C8,10.896,8.897,10,10,10 M10,8c-2.209,0-4,1.791-4,4s1.791,4,4,4s4-1.791,4-4S12.209,8,10,8L10,8z\"/>\n      <path d=\"M15,6c0.553,0,1,0.448,1,1c0,0.553-0.447,1-1,1s-1-0.447-1-1C14,6.448,14.447,6,15,6z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG CAMERA -->\n\n  <!-- SVG GIF -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-gif\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M3.676,5.098L2.243,3.665C1.025,5.153,0.201,6.975,0,8.995h2.053C2.237,7.534,2.822,6.206,3.676,5.098z M8.995,2.028V0C6.974,0.201,5.152,1.025,3.664,2.243l1.429,1.428\n        C6.199,2.807,7.527,2.212,8.995,2.028z M16.336,2.243C14.847,1.025,13.025,0.201,11.006,0v2.028c1.468,0.184,2.795,0.778,3.902,1.643L16.336,2.243z M17.947,8.995H20c-0.201-2.021-1.025-3.842-2.242-5.33l-1.435,1.433C17.179,6.206,17.764,7.534,17.947,8.995z M2.053,11.005H0c0.201,2.021,1.025,3.842,2.243,5.33l1.433-1.434\n        C2.822,13.793,2.237,12.466,2.053,11.005z M11.006,17.971V20c2.02-0.2,3.841-1.025,5.33-2.243l-1.428-1.428C13.801,17.193,12.474,17.787,11.006,17.971z M3.664,17.757C5.152,18.975,6.974,19.8,8.995,20v-2.029c-1.468-0.184-2.796-0.777-3.902-1.642L3.664,17.757z M16.323,14.901l1.435,1.434c1.217-1.488,2.041-3.31,2.242-5.33h-2.053C17.764,12.466,17.179,13.793,16.323,14.901z M15.025,11.005v-2.01H10v2.01h2.831c-0.416,1.168-1.521,2.01-2.831,2.01c-1.666,0-3.016-1.35-3.016-3.016c0-1.665,1.35-3.015,3.016-3.015h3.998C13.08,5.771,11.64,4.974,10,4.974c-2.776,0-5.026,2.25-5.026,5.025c0,2.774,2.25,5.025,5.026,5.025C12.432,15.024,14.56,13.298,15.025,11.005z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG GIF -->\n\n  <!-- SVG TAGS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-tags\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M20,13.001v2h-6L13,20h-2l1-4.999H6L5,20H3l1-4.999H0v-2h4.4L5.6,7H0V5h6l1-5h2L8,5h6l1-5h2l-1,5h4v2h-4.4L14.4,13.001H20z M13.6,7h-6l-1.2,6.001h6L13.6,7z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG TAGS -->\n\n  <!-- SVG QUOTE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-quote\" viewBox=\"0 0 32 22\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M12.998,5l-1-5C3.897,0.622,0,4.275,0,12.904V22h10.998V11H6.997C6.597,7.035,8.106,5.854,12.998,5z M32,5l-1.001-5c-8.1,0.622-11.998,4.275-11.998,12.904V22h10.998V11h-4C25.599,7.035,27.107,5.854,32,5z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG QUOTE -->\n\n  <!-- SVG PIN -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-pin\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,2c3.309,0,6,2.773,6,6.182c0,4.78-4.517,9.104-5.994,9.768C8.557,17.272,4,12.836,4,8.182C4,4.773,6.691,2,10,2 M10,0C5.581,0,2,3.663,2,8.182C2,14.291,8.192,20,10,20c1.807,0,8-5.596,8-11.818C18,3.663,14.418,0,10,0L10,0z\"/>\n      <path d=\"M10,6c1.103,0,2,0.897,2,2c0,1.103-0.897,2-2,2c-1.103,0-2-0.897-2-2C8,6.897,8.897,6,10,6 M10,4C7.791,4,6,5.791,6,8s1.791,4,4,4s4-1.791,4-4S12.209,4,10,4L10,4z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG PIN -->\n\n  <!-- SVG TICKET -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-ticket\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M15,2v16h-1.537c-0.692-1.194-1.985-2-3.463-2s-2.771,0.806-3.463,2H5V2h1.537C7.229,3.195,8.522,4,10,4s2.771-0.805,3.463-2H15 M17,0h-5c0,1.104-0.896,2-2,2S8,1.104,8,0H3v20h5c0-1.104,0.896-2,2-2s2,0.896,2,2h5V0L17,0z\"/>\n      <rect x=\"7\" y=\"7\" width=\"6\" height=\"2\"/>\n      <rect x=\"7\" y=\"11\" width=\"4\" height=\"2\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG TICKET -->\n\n  <!-- SVG EVENTS MONTHLY -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-events-monthly\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,20H4c-2.209,0-4-1.791-4-4.001V6c0-2.209,1.791-4,4-4h1V0h2v2h6V0h2v2h1c2.209,0,4,1.791,4,4v9.999C20,18.209,18.209,20,16,20z M18,6c0-1.103-0.897-2-2-2h-1v2h-2V4H7v2H5V4H4C2.896,4,2,4.897,2,6v9.999C2,17.103,2.896,18,4,18h12c1.103,0,2-0.897,2-2.001V6z M13,13.001h2v2h-2V13.001z M13,9.001h2v2h-2V9.001z M9,13.001h2v2H9V13.001z M9,9.001h2v2H9V9.001z M5,13.001h2v2H5V13.001z M5,9.001h2v2H5V9.001z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG EVENTS MONTHLY -->\n\n  <!-- SVG EVENTS WEEKLY -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-events-weekly\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,20H4c-2.209,0-4-1.791-4-4.001V6c0-2.209,1.791-4,4-4h1V0h2v2h6V0h2v2h1c2.209,0,4,1.791,4,4v9.999C20,18.209,18.209,20,16,20z M18,6c0-1.103-0.897-2-2-2h-1v2h-2V4H7v2H5V4H4C2.896,4,2,4.897,2,6v9.999C2,17.103,2.896,18,4,18h12c1.103,0,2-0.897,2-2.001V6z M5,13.001h10v2H5V13.001z M5,9.001h10v2H5V9.001z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG EVENTS WEEKLY -->\n\n  <!-- SVG EVENTS DAILY -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-events-daily\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,20H4c-2.209,0-4-1.791-4-4.001V6c0-2.209,1.791-4,4-4h1V0h2v2h6V0h2v2h1c2.209,0,4,1.791,4,4v9.999C20,18.209,18.209,20,16,20z M18,6c0-1.103-0.897-2-2-2h-1v2h-2V4H7v2H5V4H4C2.896,4,2,4.897,2,6v9.999C2,17.103,2.896,18,4,18h12c1.103,0,2-0.897,2-2.001V6z M7,15.001H5v-2v-2v-2h2h6h2v2v2v2h-2H7zM13,11.001H7v2h6V11.001z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG EVENTS DAILY -->\n\n  <!-- SVG INFO -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-info\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M9,15h2V9H9V15z M9,7h2V5H9V7z M16-0.001H4c-2.209,0-4,1.791-4,4v12c0,2.209,1.791,4,4,4h12c2.209,0,4-1.791,4-4v-12C20,1.79,18.209-0.001,16-0.001z M18,15.999C18,17.102,17.103,18,16,18H4c-1.103,0-2-0.898-2-2.001v-12c0-1.103,0.897-2,2-2h12c1.103,0,2,0.897,2,2V15.999z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG INFO -->\n\n  <!-- SVG CHECK -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-check\" viewBox=\"0 0 12 9\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M12,1.5L4.5,9L3,7.499l0,0L0,4.5L1.5,3l3,3l6-6L12,1.5z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG CHECK -->\n\n  <!-- SVG TROPHY -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-trophy\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M19.968,4.031C19.941,5.666,19.579,11,15.99,11h-0.125c-0.426,2.357-2.111,2.999-5.858,2.999c-3.748,0-5.434-0.642-5.859-2.999H4.009c-3.588,0-3.951-5.333-3.977-6.969L0,2h2.028h1.98h0.015V0H15.99v2l0,0h1.981H20L19.968,4.031z M4.009,3.999L1.994,4c0,0,0.112,4.999,2.015,4.999V3.999z M13.993,2H6.02v7.6c0,2.385,0.741,2.399,3.987,2.399c3.245,0,3.986-0.014,3.986-2.399V2z M17.972,3.999H15.99v5C17.893,8.999,18.006,4,18.006,4L17.972,3.999z M11.005,15.999H13c2.206,0,3.993,1.789,3.993,4h-1.989h-0.006c0-1.104-0.896-2.001-1.998-2.001h-1.995H9.009H7.013c-1.102,0-1.996,0.896-1.996,2.001H4.996H3.02c0-2.211,1.788-4,3.993-4h1.996v-2.001h0.998h0.998V15.999z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG TROPHY -->\n\n  <!-- SVG CLOCK -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-clock\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M10,0C4.486,0,0,4.485,0,9.999c0,5.515,4.486,10,10,10c5.514,0,10-4.485,10-10C20,4.485,15.514,0,10,0zM10,17.999c-4.414,0-8.005-3.589-8.005-8S5.586,2,10,2c4.414,0,8.005,3.588,8.005,7.999S14.414,17.999,10,17.999z M14.437,12.105l-3.44-1.724V4.999C10.997,4.447,10.551,4,10,4S9.002,4.447,9.002,4.999V11c0,0.379,0.213,0.725,0.551,0.894l3.99,2C13.687,13.966,13.838,14,13.988,14c0.367,0,0.719-0.203,0.894-0.554C15.128,12.953,14.929,12.352,14.437,12.105z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG CLOCK -->\n\n  <!-- SVG RETURN -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-return\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M19.12,13.852c-1.047,2.187-2.896,3.834-5.203,4.638C12.922,18.835,11.905,19,10.906,19c-3.751,0-7.273-2.313-8.59-6.006c-0.186-0.52,0.086-1.092,0.606-1.277c0.52-0.189,1.092,0.085,1.277,0.605c1.301,3.646,5.367,5.563,9.06,4.278c1.801-0.627,3.241-1.909,4.057-3.614c0.802-1.675,0.9-3.56,0.277-5.308c-1.3-3.644-5.363-5.562-9.06-4.278C7.541,3.746,6.623,4.316,5.877,5.052l-2.33,2.163h2.852c0.553,0,1,0.448,1,1c0,0.552-0.447,1-1,1H1c-0.007,0-0.013-0.004-0.019-0.004C0.901,9.21,0.826,9.185,0.749,9.164C0.699,9.151,0.646,9.149,0.601,9.13C0.555,9.109,0.518,9.071,0.474,9.044c-0.066-0.043-0.137-0.08-0.191-0.138C0.277,8.901,0.271,8.9,0.267,8.896C0.231,8.857,0.218,8.811,0.189,8.769C0.147,8.707,0.101,8.649,0.073,8.579C0.045,8.507,0.039,8.432,0.028,8.355C0.021,8.307,0,8.264,0,8.214V2.882c0-0.552,0.447-1,1-1c0.552,0,1,0.448,1,1v3.041l2.495-2.315c0.935-0.922,2.111-1.653,3.382-2.096c4.728-1.646,9.933,0.819,11.6,5.495C20.281,9.261,20.154,11.69,19.12,13.852z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG RETURN -->\n\n  <!-- SVG DRIBBBLE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-dribbble\" viewBox=\"0 0 12 12\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M6,11.999c-3.313,0-6-2.687-6-6c0-3.313,2.687-6,6-6s6,2.686,6,6C12,9.313,9.313,11.999,6,11.999z M7.434,4.992C7.585,5.295,7.728,5.599,7.86,5.896c0.814-0.135,1.696-0.139,2.634,0.046c-0.01-0.874-0.272-1.686-0.713-2.373C9.062,4.167,8.257,4.632,7.434,4.992z M9.104,9.244c0.599-0.573,1.036-1.31,1.247-2.138c-0.484-0.085-1.184-0.15-2.008-0.054C8.681,7.915,8.935,8.684,9.104,9.244z M5.994,10.495c0.708,0,1.375-0.167,1.972-0.459C7.812,9.095,7.532,8.167,7.188,7.285C6.014,7.624,4.701,8.333,3.44,9.7C4.166,10.2,5.045,10.495,5.994,10.495z M2.556,8.897c0.8-0.837,2.245-2.097,4.159-2.722C6.593,5.913,6.466,5.659,6.337,5.409C4.395,6.05,2.505,6.189,1.501,6.212C1.551,7.233,1.938,8.165,2.556,8.897z M1.593,5.048c1.733-0.13,3.096-0.387,4.16-0.7c-0.613-1.05-1.216-1.906-1.624-2.45C2.851,2.481,1.894,3.642,1.593,5.048z M5.994,1.49c-0.258,0-0.509,0.027-0.754,0.068C5.864,2.29,6.409,3.113,6.885,3.955c1.091-0.447,1.737-0.937,2.108-1.311C8.197,1.929,7.148,1.49,5.994,1.49z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG DRIBBBLE -->\n\n  <!-- SVG ITEM -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-item\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M19,5h-1.952C17.209,4,17.3,3.943,17.3,3.5c0-1.792-1.458-3.375-3.25-3.375c-2.035,0-3.296,1.306-4.049,2.653C9.248,1.431,7.985,0.031,5.95,0.031c-1.792,0-3.25,1.692-3.25,3.484C2.7,3.958,2.791,4,2.952,5H1C0.448,5,0,4.948,0,5.5V10c0,0.552,0.448,1,1,1h1v5c0,2.209,1.791,4,4,4h3h2h3c2.209,0,4-1.791,4-4v-5h1c0.553,0,1-0.448,1-1V5.5C20,4.948,19.553,5,19,5z M14.05,2.25c0.689,0,1.25,0.686,1.25,1.375S14.739,5,14.05,5h-2.693C11.788,3,12.626,2.25,14.05,2.25zM5.95,2.375C7.375,2.375,8.212,3,8.644,5H5.95C5.261,5,4.7,4.189,4.7,3.5S5.261,2.375,5.95,2.375z M9,18H6c-1.103,0-2-0.897-2-2v-5h5V18z M16,16c0,1.103-0.897,2-2,2h-3v-7h5V16z M18,9h-4h-3H9H5H2V7h3h0.95H9h2h3h0.05H18V9z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG ITEM -->\n\n  <!-- SVG WALLET -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-wallet\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M20,9h-2V8c0-1.999-1.471-3.641-3.387-3.938l-0.395-1.548C13.832,0.999,12.527,0,11.104,0c-0.276,0-0.557,0.038-0.836,0.116l-7.79,2.194C1.155,2.684,0.2,3.72,0.033,5H0v3v1v7c0,2.209,1.791,4,4,4h10c2.209,0,4-1.791,4-4v-1h2V9z M10.81,2.042C10.908,2.014,11.006,2,11.104,2c0.543,0,1.025,0.415,1.178,1.008L12.534,4H4C3.924,4,3.853,4.018,3.778,4.022L10.81,2.042z M16,16c0,1.103-0.897,2-2,2H4c-1.103,0-2-0.897-2-2V9V8c0-1.103,0.897-2,2-2h10c1.103,0,2,0.897,2,2v1h-1c-1.657,0-3,1.344-3,3s1.343,3,3,3h1V16z M18,13h-3c-0.552,0-1-0.448-1-1s0.448-1,1-1h3V13z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG WALLET -->\n\n  <!-- SVG EARNINGS -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-earnings\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,20h-1v-2h1c1.103,0,2-0.897,2-2v-1h2v1C20,18.209,18.209,20,16,20z M18,11h2v2h-2V11z M18,7h2v2h-2V7z M18,4c0-1.103-0.897-2-2-2h-1V0h1c2.209,0,4,1.791,4,4v1h-2V4zM8.75,9h2.5C12.767,9,14,10.346,14,12s-1.233,3-2.75,3H11v1H9v-1H7c-0.553,0-1-0.447-1-1s0.447-1,1-1h2h2h0.25c0.406,0,0.75-0.458,0.75-1s-0.344-1-0.75-1h-2.5C7.233,11,6,9.654,6,8s1.233-3,2.75-3H9V4h2v1h1.5c0.553,0,1,0.448,1,1s-0.447,1-1,1H11H9H8.75C8.344,7,8,7.458,8,8S8.344,9,8.75,9z M11,0h2v2h-2V0z M7,0h2v2H7V0z M0,16v-1h2v1c0,1.103,0.896,2,2,2h1v2H4C1.791,20,0,18.209,0,16z M2,4v1H0V4c0-2.209,1.791-4,4-4h1v2H4C2.896,2,2,2.897,2,4z M2,7v2H0V7H2z M2,13H0v-2h2V13z M9,20H7v-2h2V20z M13,20h-2v-2h2V20z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG EARNINGS -->\n\n  <!-- SVG REVENUE -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-revenue\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M16,0H4C1.791,0,0,1.791,0,4v12c0,2.209,1.791,4,4,4h12c2.209,0,4-1.791,4-4V4C20,1.791,18.209,0,16,0zM18,16c0,1.103-0.897,2-2,2H4c-1.103,0-2-0.897-2-2V4c0-1.103,0.897-2,2-2h12c1.103,0,2,0.897,2,2V16z\"/>\n      <path d=\"M11.25,9h-2.5C8.344,9,8,8.542,8,8s0.344-1,0.75-1h3.75c0.553,0,1-0.448,1-1s-0.447-1-1-1H11V4H9v1H8.75C7.233,5,6,6.346,6,8s1.233,3,2.75,3h2.5c0.406,0,0.75,0.458,0.75,1s-0.344,1-0.75,1H7c-0.553,0-1,0.447-1,1s0.447,1,1,1h2v1h2v-1h0.25c1.517,0,2.75-1.346,2.75-3S12.767,9,11.25,9z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG REVENUE -->\n\n  <!-- SVG LOGIN -->\n  <svg style=\"display: none;\">\n    <symbol id=\"svg-login\" viewBox=\"0 0 20 20\" preserveAspectRatio=\"xMinYMin meet\">\n      <path d=\"M13,2.523v2.176c2.358,1.126,4,3.513,4,6.301c0,3.866-3.134,7-7,7s-7-3.134-7-7c0-2.788,1.642-5.175,4-6.301V2.523C3.507,3.76,1,7.083,1,11c0,4.971,4.029,9,9,9s9-4.029,9-9\n      C19,7.083,16.493,3.76,13,2.523z M11,0H9v10h2V0z\"/>\n    </symbol>\n  </svg>\n  <!-- FINE ICONA SVG LOGIN -->\n";svgWrap.innerHTML=svgData;document.body.appendChild(svgWrap);
