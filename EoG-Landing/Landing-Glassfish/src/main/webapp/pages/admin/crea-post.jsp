        ...
        <div class="container">
            <div class="row" style="text-align: center">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form action="./carica-post.jsp" method="POST" name="PostForm">
                        <label>
                            Titolo:
                        ...
                        <label>
                            ...
                            <textarea class="form-control" rows="6" cols="30" name="contenutoCard" required
                                      style="color: black">Inserisci qui il contenuto della card della home</textarea>
                        </label><br/>
                        <label>
                            Contenuto:
                            <textarea class="form-control" rows="6" cols="50" name="contenuto" required
                                      style="color: black">Inserisci qui il contenuto del post</textarea>
                        </label><br/>
