...
<head>
    ...
    <title>Lista Utenti | EoG Blog</title>
            ...
            <div class="row" style="text-align: center">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <table class="center" style="width: 100%;">
                        <tr>
                            <td style="font-weight: bold">ID Utente</td>
                        ...
                        <%
                            try {
                                ...
                                String sql = "select * from Utente_Blog order by UserID asc";
                        ...
                        <tr>
                            ...
                            <td>
                                <%= AES.decrypt(resultSet.getString("Username"), encryptionKey) %>
                            </td>
                            <td>
                                <%= AES.decrypt(resultSet.getString("Email"), encryptionKey) %>
                            </td>
                            <td>
                                <%= AES.decrypt(resultSet.getString("Nome"), encryptionKey) %>
                            </td>
                            <td>
                                <%= AES.decrypt(resultSet.getString("Cognome"), encryptionKey) %>
                            </td>
                            <td>
                                <%= resultSet.getBoolean("Admin") ? "Amministratore" : "Utente" %>
                            </td>
                            <% if(!resultSet.getBoolean("Admin")) { %>
                            <td>
                                <a href="imposta-admin.jsp?id=<%=resultSet.getString("UserID") %>">
                                    <button type="button" class="btn btn-success btn-sm">Rendi Admin</button>
                                </a>
                            </td>
                            <% } %>
                            <td>
                                <a href="rimuovi-admin.jsp?id=<%=resultSet.getString("UserID") %>">
                                    <button type="button" class="btn btn-danger btn-sm">Rimuovi Admin</button>
                                </a>
                            </td>
                            <td>
                                <a href="elimina-utente.jsp?id=<%=resultSet.getString("UserID") %>">
                                    <button type="button" class="btn btn-danger btn-sm">Elimina Utente</button>
                                </a>
                            </td>
                        </tr>
                        <%
